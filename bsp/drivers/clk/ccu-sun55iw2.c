...
#include "ccu-sun55iw2.h"

/* ccu_des_start */
#define SUN55IW2_PLL_REF_CTRL_REG   0x0000
static struct ccu_nkmp pll_ref_clk = {
	...
	.common		= {
		.reg		= 0x0000,
		.hw.init	= CLK_HW_INIT("pll-ref", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_DDR_CTRL_REG   0x0020
...
#define SUN55IW2_PLL_PERI0_CTRL_REG   0x00A0
...
#define SUN55IW2_PLL_PERI1_CTRL_REG   0x00C0
...
#define SUN55IW2_PLL_GPU0_CTRL_REG   0x00E0
static struct ccu_nkmp pll_gpu0_clk = {
	...
	.common		= {
		.reg		= 0x00E0,
		.hw.init	= CLK_HW_INIT("pll-gpu0", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_VIDEO0_CTRL_REG   0x0120
...
static struct ccu_nkmp pll_video0_3x_clk = {
	...
	.common		= {
		.reg		= 0x0120,
		.hw.init	= CLK_HW_INIT("pll-video0-3x", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_VIDEO1_CTRL_REG   0x0140
...
static struct ccu_nkmp pll_video1_3x_clk = {
	...
	.common		= {
		.reg		= 0x0120,
		.hw.init	= CLK_HW_INIT("pll-video1-3x", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_VIDEO2_CTRL_REG   0x0160
...
static struct ccu_nkmp pll_video2_3x_clk = {
	...
	.common		= {
		.reg		= 0x0160,
		.hw.init	= CLK_HW_INIT("pll-video2-3x", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_VIDEO3_CTRL_REG   0x0180
...
static struct ccu_nkmp pll_video3_3x_clk = {
	...
	.common		= {
		.reg		= 0x0180,
		.hw.init	= CLK_HW_INIT("pll-video3-3x", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_VE0_CTRL_REG   0x0220
static struct ccu_nkmp pll_ve0_clk = {
	.enable		= BIT(27),
	.lock		= BIT(28),
	.n		= _SUNXI_CCU_MULT_MIN(8, 8, 12),
	.m		= _SUNXI_CCU_DIV(1, 1), /* input divider */
	.p		= _SUNXI_CCU_DIV(8, 7), /* output divider */
	.common		= {
		.reg		= 0x0220,
		.hw.init	= CLK_HW_INIT("pll-ve0", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_VE1_CTRL_REG   0x0240
static struct ccu_nkmp pll_ve1_clk = {
	...
	.common		= {
		.reg		= 0x0220,
		.hw.init	= CLK_HW_INIT("pll-ve1", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_AUDIO0_CTRL_REG   0x0260
...
#define SUN55IW2_PLL_NPU_CTRL_REG   0x02A0
static struct ccu_nkmp pll_npu_clk = {
	...
	.common		= {
		.reg		= 0x02A0,
		.hw.init	= CLK_HW_INIT("pll-npu", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_DE_CTRL_REG   0x02E0
static struct ccu_nkmp pll_de_4x_clk = {
	...
	.common		= {
		.reg		= 0x02E0,
		.hw.init	= CLK_HW_INIT("pll-de-4x", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
static struct ccu_nkmp pll_de_3x_clk = {
	...
	.common		= {
		.reg		= 0x02E0,
		.hw.init	= CLK_HW_INIT("pll-de-3x", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
#define SUN55IW2_PLL_CCI_CTRL_REG   0x0320
static struct ccu_nkmp pll_cci_clk = {
	...
	.common		= {
		.reg		= 0x0320,
		.hw.init	= CLK_HW_INIT("pll-cci", "dcxo24M",
				&ccu_nkmp_ops,
				CLK_SET_RATE_UNGATE |
				CLK_IS_CRITICAL),
	},
...
static const char * const ahb_apb_parents[] = { "dcxo24M", "ext-32k", "rc-16m", "pll-peri0-600m" };
...
static const char * const apb_uart_parents[] = { "dcxo24M", "ext-32k", "rc-16m", "pll-peri0-600m", "pll-peri0-480m" };
...
static const char * const trace_parents[] = { "dcxo24M", "ext-32k", "rc-16m", "pll-peri0-300m", "pll-peri0-400m" };
...
static const char * const cci_parents[] = { "dcxo24M", "pll-cci", "pll-peri0-800m", "pll-peri0-600m", "depll3x", "pll-ddr" };
...
static const char * const gic_parents[] = { "dcxo24M", "pll-peri0-480m", "ext-32k", "pll-peri0-600m" };
...
static const char * const timer_clk_parents[] = { "sys24M", "rc-16m", "ext-32k", "pll-peri0-200m", "dcxo24M" };
...
static const char * const ce_parents[] = { "dcxo24M", "pll-peri0-400m", "pll-peri0-600m" };
...
static const char * const dsp_parents[] = { "dcxo24M", "ext-32k", "rc-16m", "peri0pll2x", "pll-peri0-480m" };
...
static const char * const nand0_clk0_parents[] = { "dcxo24M", "pll-peri1-400m", "pll-peri1-300m", "pll-peri0-400m", "pll-peri0-300m" };
...
static const char * const nand0_clk1_parents[] = { "dcxo24M", "pll-peri1-400m", "pll-peri1-300m", "pll-peri0-400m", "pll-peri0-300m" };
...
static const char * const smhc0_parents[] = { "dcxo24M", "pll-peri1-400m", "pll-peri1-300m", "pll-peri0-400m", "pll-peri0-300m" };
...
static const char * const smhc0_24m_parents[] = { "sys24M", "dcxo24M" };
...
static const char * const smhc1_parents[] = { "dcxo24M", "pll-peri1-400m", "pll-peri1-300m", "pll-peri0-400m", "pll-peri0-300m" };
...
static const char * const smhc2_parents[] = { "dcxo24M", "pll-peri1-800m", "pll-peri1-600m", "pll-peri0-800m", "pll-peri0-600m" };
...
static const char * const smhc2_24m_parents[] = { "sys24M", "dcxo24M" };
...
static const char * const smhc3_parents[] = { "dcxo24M", "pll-peri1-800m", "pll-peri1-600m", "pll-peri0-800m", "pll-peri0-600m" };
...
static const char * const smhc3_24m_parents[] = { "sys24M", "dcxo24M" };
...
static const char * const spi_parents[] = { "sys24M", "pll-peri0-300m", "pll-peri0-200m", "pll-peri1-300m", "pll-peri1-200m", "peri0-160m", "peri1-160m", "dcxo24M" };
...
static const char * const spif_parents[] = { "sys24M", "pll-peri0-400m", "pll-peri0-300m", "pll-peri1-400m", "pll-peri1-300m", "peri0-160m", "peri1-160m", "dcxo24M" };
...
static const char * const gpadc0_24m_parents[] = { "sys24M", "dcxo24M" };
...
static const char * const gpadc1_24m_parents[] = { "sys24M", "dcxo24M" };
...
static const char * const irrx_parents[] = { "ext-32k", "sys24M", "dcxo24M" };
...
static const char * const irtx_parents[] = { "sys24M", "pll-peri1-600m", "dcxo24M" };
...
static SUNXI_CCU_GATE(usb2_hos1t_clk, "usb2-host1",
		"dcxo24M",
		0x1308, BIT(31), 0);
...
static const char * const usb2_ref_parents[] = { "sys24M", "dcxo24M" };
static SUNXI_CCU_MUX_WITH_GATE(usb2_ref_clk, "usb2-ref",
		usb2_ref_parents, 0x1340,
		24, 3,	/* mux */
		BIT(31), 0);

static const char * const usb3_usb2_ref_parents[] = { "sys24M", "pll-peri0-300m", "dcxo24M" };
...
static const char * const usb3_suspend_parents[] = { "ext-32k", "dcxo24M" };
...
static const char * const usb3_mf_parents[] = { "sys24M", "pll-peri0-300m", "dcxo24M" };
...
static const char * const pcie0_aux_parents[] = { "dcxo24M", "ext-32k" };
...
static const char * const gmac_ptp_parents[] = { "sys24M", "pll-peri0-200m", "dcxo24M" };
...
static const char * const ledc_parents[] = { "sys24M", "pll-peri0-600m", "dcxo24M" };
...
/* rst_def_start */
static struct ccu_reset_map sun55iw2_ccu_resets[] = {
	...
	[RST_USB_2_PHY0_RSTN]		= { 0x1300, BIT(30) },
	[RST_USB_2_OTG0]		= { 0x1304, BIT(24) },
	[RST_USB_2_EHCI0]		= { 0x1304, BIT(20) },
	[RST_USB_2_OHCI0]		= { 0x1304, BIT(16) },
	[RST_USB_2_PHY1_RSTN]		= { 0x1308, BIT(30) },
	[RST_USB_2_EHCI1]		= { 0x130c, BIT(20) },
	[RST_USB_2_OHCI1]		= { 0x130c, BIT(16) },
	[RST_USB_2_PHY2_RSTN]		= { 0x1310, BIT(30) },
	[RST_USB_2_EHCI2]		= { 0x1314, BIT(20) },
	[RST_USB_2_OHCI2]		= { 0x1314, BIT(16) },
	[RST_USB_3]			= { 0x1354, BIT(16) },
...
/* ccu_def_start */
static struct clk_hw_onecell_data sun55iw2_hw_clks = {
	.hws    = {
		...
		[CLK_USB2_HOS1T]		= &usb2_hos1t_clk.common.hw,
...
static struct ccu_common *sun55iw2_ccu_clks[] = {
	&pll_ref_clk.common,
	&pll_ddr_clk.common,
...
static const u32 pll_regs[] = {
	SUN55IW2_PLL_REF_CTRL_REG,
	SUN55IW2_PLL_DDR_CTRL_REG,
	SUN55IW2_PLL_PERI0_CTRL_REG,
	SUN55IW2_PLL_PERI1_CTRL_REG,
	SUN55IW2_PLL_GPU0_CTRL_REG,
	SUN55IW2_PLL_VIDEO0_CTRL_REG,
	SUN55IW2_PLL_VIDEO1_CTRL_REG,
	SUN55IW2_PLL_VIDEO3_CTRL_REG,
	SUN55IW2_PLL_VE0_CTRL_REG,
	SUN55IW2_PLL_VE1_CTRL_REG,
	SUN55IW2_PLL_AUDIO0_CTRL_REG,
	SUN55IW2_PLL_NPU_CTRL_REG,
	SUN55IW2_PLL_DE_CTRL_REG,
	SUN55IW2_PLL_CCI_CTRL_REG,
};

static const struct sunxi_ccu_desc sun55iw2_ccu_desc = {
	.ccu_clks	= sun55iw2_ccu_clks,
	.num_ccu_clks	= ARRAY_SIZE(sun55iw2_ccu_clks),

	.hw_clks	= &sun55iw2_hw_clks,

	.resets		= sun55iw2_ccu_resets,
	.num_resets	= ARRAY_SIZE(sun55iw2_ccu_resets),
};

static void __init of_sun55iw2_ccu_init(struct device_node *node)
{
	void __iomem *reg;
	int i;
	u32 val;
	...
	sunxi_ccu_probe(node, reg, &sun55iw2_ccu_desc);
}

CLK_OF_DECLARE(sun55iw2_ccu_init, "allwinner,sun55iw2-ccu", of_sun55iw2_ccu_init);

MODULE_DESCRIPTION("Allwinner sun55iw2 clk driver");
