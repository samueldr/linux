...
/* rst_def_start */
static struct ccu_reset_map sun55iw3_dsp_ccu_resets[] = {
...
/* ccu_def_start */
static struct clk_hw_onecell_data sun55iw3_dsp_hw_clks = {
	.hws    = {
...
static struct ccu_common *sun55iw3_dsp_ccu_clks[] = {
...
static const struct sunxi_ccu_desc sun55iw3_dsp_ccu_desc = {
	.ccu_clks	= sun55iw3_dsp_ccu_clks,
	.num_ccu_clks	= ARRAY_SIZE(sun55iw3_dsp_ccu_clks),

	.hw_clks	= &sun55iw3_dsp_hw_clks,

	.resets		= sun55iw3_dsp_ccu_resets,
	.num_resets	= ARRAY_SIZE(sun55iw3_dsp_ccu_resets),
};

static void __init of_sun55iw3_dsp_ccu_init(struct device_node *node)
{
	void __iomem *reg;
	int ret;
	...
	ret = sunxi_ccu_probe(node, reg, &sun55iw3_dsp_ccu_desc);
	if (ret)
		return;

	sunxi_ccu_sleep_init(reg, sun55iw3_dsp_ccu_clks,
			     ARRAY_SIZE(sun55iw3_dsp_ccu_clks),
			     NULL, 0);
}

CLK_OF_DECLARE(sun55iw3_dsp_ccu_init, "allwinner,sun55iw3-dsp-ccu", of_sun55iw3_dsp_ccu_init);
