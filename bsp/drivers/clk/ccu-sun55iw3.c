...
static SUNXI_CCU_GATE(nand_mbus_gate_sw_clk, "nand-mbus-sw-gate",
		"dcxo24M",
		0x0804, BIT(22), 0);
...
static SUNXI_CCU_GATE(g2d_mbus_gate_clk, "g2d-mbus-gate",
		"dcxo24M",
		0x0804, BIT(19), 0);

static SUNXI_CCU_GATE(ce_mbus_gate_sw_clk, "ce-mbus-sw-gate",
		"dcxo24M",
		0x0804, BIT(18), 0);

static SUNXI_CCU_GATE(ve_mbus_gate_sw_clk, "ve-mbus-sw-gate",
		"dcxo24M",
		0x0804, BIT(17), 0);
...
static SUNXI_CCU_GATE(usb3_gate_clk, "usb3-gate",
		"dcxo24M",
		0x0A8C, BIT(9), 0);
...
static SUNXI_CCU_GATE(usb_sys_ahb_gate_clk, "usb-sys-gate",
		"dcxo24M",
		0x0E04, BIT(11), 0);
...
static struct clk_hw_onecell_data sun55iw3_hw_clks = {
	.hws    = {
		...
		[CLK_NAND_MBUS_GATE_SW]		= &nand_mbus_gate_sw_clk.common.hw,
		[CLK_NPU_MBUS_GATE]		= &npu_mbus_gate_clk.common.hw,
		[CLK_VID_IN_MBUS_GATE]		= &vid_in_mbus_gate_clk.common.hw,
		[CLK_G2D_MBUS_GATE]		= &g2d_mbus_gate_clk.common.hw,
		[CLK_CE_MBUS_GATE_SW]		= &ce_mbus_gate_sw_clk.common.hw,
		[CLK_VE_MBUS_GATE_SW]		= &ve_mbus_gate_sw_clk.common.hw,
		...
		[CLK_USB3]			= &usb3_gate_clk.common.hw,
...
static struct ccu_common *sun55iw3_ccu_clks[] = {
	...
	&nand_mbus_gate_sw_clk.common,
	&npu_mbus_gate_clk.common,
	&vid_in_mbus_gate_clk.common,
	&g2d_mbus_gate_clk.common,
	&ce_mbus_gate_sw_clk.common,
	&ve_mbus_gate_sw_clk.common,
