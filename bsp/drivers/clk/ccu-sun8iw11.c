...
static struct ccu_nkmp pll_mipi_clk = {
	...
	.common		= {
		.reg		= 0x040,
		.features	= CCU_FEATURE_FIXED_POSTDIV,
		.hw.init	= CLK_HW_INIT("pll-mipi", "dcxo24M",
					      &ccu_nkmp_ops,
					      CLK_SET_RATE_UNGATE |
					      CLK_IS_CRITICAL),
	},
...
static SUNXI_CCU_GATE(di_gate_clk, "di-gate", "dcxo24M", 0x100, BIT(6), 0);
...
#if 0
static struct ccu_mux_nb sun8iw11_cpu_nb = {
