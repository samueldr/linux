...
static const char * const pll_ddr_pat_ctrl_parents[] = { "24mhz", "12mhz" };

static SUNXI_CCU_MUX(pll_ddr_pat_ctrl, "pll_ddr_pat_ctrl", pll_ddr_pat_ctrl_parents,
		0x0110, 19, 1, CLK_SET_RATE_PARENT | CLK_IS_CRITICAL);

static const char * const cpux_axi_cfg_parents[] = { "osc24m", "rtc-32k", "rc16m", "pll-cpux", "pll-peri0-1x", "reserved", "reserved", "reserved" };

static SUNXI_CCU_MUX(cpux_axi_cfg, "cpux_axi_cfg", cpux_axi_cfg_parents,
		0x0500, 24, 3, CLK_SET_RATE_PARENT | CLK_IS_CRITICAL);

static const char * const psi_ahb1_ahb2_parents[] = { "osc24m", "rtc-32k", "rc16m", "pll-peri0-1x"};
...
static const char * const ahb3_parents[] = { "osc24m", "rtc-32k", "rc16m", "pll-peri0-1x"};
...
static const char * const apb1_parents[] = { "osc24m", "rtc-32k", "psi", "pll-peri0-1x"};
...
static const char * const apb2_parents[] = { "osc24m", "rtc-32k", "psi", "pll-peri0-1x"};
...
static const char * const ce_clk_parents[] = {"osc24m", "pll-peri0"};
...
static SUNXI_CCU_GATE(nand0_gating_clk, "nand0-",
		"dcxo24M",
		0x0804, BIT(5), 0);

static SUNXI_CCU_GATE(ce_gating_clk, "ce-gating",
		"dcxo24M",
		0x0804, BIT(2), 0);

static SUNXI_CCU_GATE(dma_gating_clk, "dma-gating",
		"dcxo24M",
		0x0804, BIT(0), 0);
...
static const char * const nand0_0_clk_parents[] = {"osc24m", "pll-peri0-1x", "pll-peri1-1x", "pll-peri0-2x", "pll-peri1-2x"};
...
static const char * const nand0_1_clk_parents[] = {"osc24m", "pll-peri0-1x", "pll-peri1-1x", "pll-peri0-2x", "pll-peri1-2x"};
...
static const char * const smhc1_clk_parents[] = { "osc24m", "pll-peri0-2x", "pll-peri1-2x" };
...
static SUNXI_CCU_GATE(smhc2_gating_clk, "smhc2",
		"dcxo24M",
		0x084C, BIT(2), 0);

static SUNXI_CCU_GATE(smhc1_gating_clk, "smhc1-gating",
		"dcxo24M",
		0x084C, BIT(1), 0);

static SUNXI_CCU_GATE(smhc0_gating_clk, "smhc0-gating",
		"dcxo24M",
		0x084C, BIT(0), 0);
...
static const char * const spi0_clk_parents[] = {"osc24m", "pll-peri0-1x", "pll-peri1-1x", "pll-peri0-2x", "pll-peri1-2x"};

static SUNXI_CCU_M_WITH_MUX_GATE(spi0_clk, "spi0",
		spi0_clk_parents, 0x0940,
		0, 4,	/* M */
		24, 3,	/* mux */
		BIT(31),	/* gate */
		CLK_SET_RATE_PARENT);

static const char * const spi1_clk_parents[] = {"osc24m", "pll-peri0-1x", "pll-peri1-1x", "pll-peri0-2x", "pll-peri1-2x"};

static SUNXI_CCU_M_WITH_MUX_GATE(spi1_clk, "spi1",
		spi1_clk_parents, 0x0944,
		0, 4,	/* M */
		24, 3,	/* mux */
		BIT(31),	/* gate */
		CLK_SET_RATE_PARENT);

static SUNXI_CCU_GATE(spi1_gating_clk, "spi1_gating",
		"dcxo24M",
		0x096C, BIT(1), 0);

static SUNXI_CCU_GATE(spi0_gating_clk, "spi0-gating",
		"dcxo24M",
		0x096C, BIT(0), 0);
...
static const char * const i2s_pcm0_clk_parents[] = { "pll-audio-4x", "pll-32k" };
static struct ccu_div i2s_pcm0_clk = {
	...
	.common         = {
		.reg            = 0x0A10,
		.hw.init        = CLK_HW_INIT_PARENTS("i2s_pcm0", i2s_pcm0_clk_parents,
				&ccu_div_ops, 0),
	},
};

static const char * const i2s_pcm1_clk_parents[] = { "pll-audio-4x", "pll-32k" };
static struct ccu_div i2s_pcm1_clk = {
	...
	.common         = {
		.reg            = 0x0A14,
		.hw.init        = CLK_HW_INIT_PARENTS("i2s_pcm1", i2s_pcm1_clk_parents,
				&ccu_div_ops,
				0),
	},
};

static const char * const i2s_pcm2_clk_parents[] = { "pll-audio-4x", "pll-32k" };
static struct ccu_div i2s_pcm2_clk = {
	...
	.common         = {
		.reg            = 0x0A18,
		.hw.init        = CLK_HW_INIT_PARENTS("i2s_pcm2", i2s_pcm2_clk_parents,
				&ccu_div_ops,
				0),
	},
};
...
static SUNXI_CCU_GATE(i2s_pcm0_gating_clk, "i2s_pcm0",
		"dcxo24M",
		0x0A1C, BIT(0), 0);

static SUNXI_CCU_GATE(i2s_pcm1_gating_clk, "i2s_pcm1",
		"dcxo24M",
		0x0A1C, BIT(1), 0);

static SUNXI_CCU_GATE(i2s_pcm2_gating_clk, "i2s_pcm2",
		"dcxo24M",
		0x0A1C, BIT(2), 0);

static const char * const spdif_clk_parents[] = { "pll-audio-4x", "pll-32k" };
...
static SUNXI_CCU_GATE(spdif_gating_clk, "spdif",
		"dcxo24M",
		0x0A2C, BIT(0), 0);

static const char * const dmic_clk_parents[] = { "pll-audio-4x", "pll-32k" };
...
static SUNXI_CCU_GATE(dmic_gating_clk, "dmic",
		"dcxo24M",
		0x0A4C, BIT(0), 0);

static const char * const audio_codec_1x_clk_parents[] = { "pll-audio-4x", "pll-32k"};
...
static const char * const audio_codec_4x_clk_parents[] = { "pll-audio-4x", "pll-32k"};
...
static const char * const lpsd_parents[] = { "osc24m", "pll-audio-1x", "pll-32k" };
...
static const char * const led_parents[] = { "osc24m", "pll-audio-1x"};
...
/* rst_def_start */
static struct ccu_reset_map sun8iw18_ccu_resets[] = { [RST_MBUS]			= { 0x540, BIT(30) },
...
static struct clk_hw_onecell_data sun8iw18_hw_clks = {
	.hws    = {
		...
		[CLK_PLL_DDR_PAT_CTRL]		= &pll_ddr_pat_ctrl.common.hw,
		[CLK_CPUX_AXI_CFG]		= &cpux_axi_cfg.common.hw,
		...
		[CLK_DMA_BUS]			= &dma_bus_clk.common.hw,
		[CLK_HSTIMER_BUS]		= &hstimer_bus_clk.common.hw,
		[CLK_AVS]			= &avs_clk.common.hw,
		[CLK_DBGSYS]			= &dbgsys_clk.common.hw,
		[CLK_PSI]			= &psi_clk.common.hw,
		[CLK_PWM]			= &pwm_clk.common.hw,
		[CLK_DRAM]			= &dram_clk.common.hw,
		[CLK_NAND0_GATING]		= &nand0_gating_clk.common.hw,
		[CLK_CE_GATING]			= &ce_gating_clk.common.hw,
		[CLK_DMA_GATING]		= &dma_gating_clk.common.hw,
		[CLK_DRAM_BUS]			= &dram_bus_clk.common.hw,
		...
		[CLK_SMHC2_GATING]		= &smhc2_gating_clk.common.hw,
		[CLK_SMHC1_GATING]		= &smhc1_gating_clk.common.hw,
		[CLK_SMHC0_GATING]		= &smhc0_gating_clk.common.hw,
		...
		[CLK_SPI1_GATING]		= &spi1_gating_clk.common.hw,
		[CLK_SPI0_GATING]		= &spi0_gating_clk.common.hw,
		[CLK_GPADC_BUS]			= &gpadc_bus_clk.common.hw,
		[CLK_THS_BUS]			= &ths_bus_clk.common.hw,
		[CLK_I2S_PCM0]			= &i2s_pcm0_clk.common.hw,
		[CLK_I2S_PCM1]			= &i2s_pcm1_clk.common.hw,
		[CLK_I2S_PCM2]			= &i2s_pcm2_clk.common.hw,
		[CLK_I2S_PCM0_GATING]			= &i2s_pcm0_gating_clk.common.hw,
		[CLK_I2S_PCM1_GATING]			= &i2s_pcm1_gating_clk.common.hw,
		[CLK_I2S_PCM2_GATING]			= &i2s_pcm2_gating_clk.common.hw,
		[CLK_SPDIF]			= &spdif_clk.common.hw,
		[CLK_SPDIF_GATING]			= &spdif_gating_clk.common.hw,
		[CLK_DMIC]			= &dmic_clk.common.hw,
		[CLK_DMIC_GATING]			= &dmic_gating_clk.common.hw,
...
static struct ccu_common *sun8iw18_ccu_clks[] = {
	...
	&dram_clk.common,
	&dram_clk.common,
	&nand0_gating_clk.common,
	&ce_gating_clk.common,
	&dma_gating_clk.common,
	&dram_bus_clk.common,
	&nand0_0_clk.common,
	&nand0_1_clk.common,
	&nand0_bus_clk.common,
	&smhc1_clk.common,
	&smhc2_gating_clk.common,
	&smhc1_gating_clk.common,
	&smhc0_gating_clk.common,
	&uart3_clk.common,
	&uart2_clk.common,
	&uart1_clk.common,
	&uart0_clk.common,
	...
	&spi0_clk.common,
	&spi1_clk.common,
	&spi1_gating_clk.common,
	&spi0_gating_clk.common,
	...
	&i2s_pcm2_clk.common,
	&spdif_clk.common,
	&spdif_gating_clk.common,
	&dmic_clk.common,
	&dmic_gating_clk.common,
