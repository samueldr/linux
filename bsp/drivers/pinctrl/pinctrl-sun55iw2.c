...
static const struct sunxi_desc_pin sun55iw2_pins[] = {
...
static const unsigned int sun55iw2_irq_bank_map[] = {
...
static const struct sunxi_pinctrl_desc sun55iw2_pinctrl_data = {
	.pins = sun55iw2_pins,
	.npins = ARRAY_SIZE(sun55iw2_pins),
	.irq_banks = ARRAY_SIZE(sun55iw2_irq_bank_map),
	.irq_bank_map = sun55iw2_irq_bank_map,
...
static int sun55iw2_pinctrl_probe(struct platform_device *pdev)
{
	struct resource *res;
	...
	return sunxi_bsp_pinctrl_init(pdev, &sun55iw2_pinctrl_data);
}

static int __maybe_unused sun55iw2_pinctrl_suspend_noirq(struct device *dev)
{
...
static int __maybe_unused sun55iw2_pinctrl_resume_noirq(struct device *dev)
{
	struct sunxi_pinctrl *pctl = dev_get_drvdata(dev);
	unsigned long flags;
...
static struct of_device_id sun55iw2_pinctrl_match[] = {
	{ .compatible = "allwinner,sun55iw2-pinctrl", },
	{}
};
MODULE_DEVICE_TABLE(of, sun55iw2_pinctrl_match);

static const struct dev_pm_ops sun55iw2_pinctrl_pm_ops = {
	.suspend_noirq = sun55iw2_pinctrl_suspend_noirq,
	.resume_noirq = sun55iw2_pinctrl_resume_noirq,
};

static struct platform_driver sun55iw2_pinctrl_driver = {
	.probe	= sun55iw2_pinctrl_probe,
	.driver	= {
		.name		= "sun55iw2-pinctrl",
		.pm = &sun55iw2_pinctrl_pm_ops,
		.of_match_table	= sun55iw2_pinctrl_match,
	},
};

static int __init sun55iw2_pio_init(void)
{
	return platform_driver_register(&sun55iw2_pinctrl_driver);
}
postcore_initcall(sun55iw2_pio_init);

MODULE_DESCRIPTION("Allwinner sun55iw2 pio pinctrl driver");
MODULE_LICENSE("GPL");
