...
#define AXP22X_STATUS_AC_USED		BIT(6)
#define AXP22X_STATUS_VBUS_PRESENT	BIT(5)
#define AXP22X_STATUS_VBUS_USED		BIT(4)
#define AXP22X_STATUS_BAT_CUR_DIRCT	BIT(2)

/* reg AXP22X_MODE_CHGSTATUS */
#define AXP22X_CHGSTATUS_BAT_CHARGING	BIT(6)
#define AXP22X_CHGSTATUS_BAT_PRESENT	BIT(5)
#define AXP22X_CHGSTATUS_BAT_PST_VALID	BIT(4)

/* reg AXP22X_MODE_CHGSTATUS */
#define AXP22X_FAULT_LOG_COLD		BIT(0)
#define AXP22X_FAULT_LOG_CHA_CUR_LOW	BIT(2)
#define AXP22X_FAULT_LOG_BATINACT	BIT(3)
#define AXP22X_FAULT_LOG_OVER_TEMP	BIT(7)

#define AXP22X_MANUFACTURER  "xpower,axp22x"

#define AXP22X_ADC_BATVOL_ENABLE         BIT(7)
#define AXP22X_ADC_BATCUR_ENABLE         BIT(6)
#define AXP22X_ADC_DCINVOL_ENABLE        BIT(5)
#define AXP22X_ADC_DCINCUR_ENABLE        BIT(4)
#define AXP22X_ADC_USBVOL_ENABLE         BIT(3)
#define AXP22X_ADC_USBCUR_ENABLE         BIT(2)
#define AXP22X_ADC_APSVOL_ENABLE         BIT(1)
#define AXP22X_ADC_TSVOL_ENABLE          BIT(0)
#define AXP22X_ADC_INTERTEM_ENABLE       BIT(7)
#define AXP22X_ADC_GPIO0_ENABLE          BIT(3)
#define AXP22X_ADC_GPIO1_ENABLE          BIT(2)
#define AXP22X_ADC_GPIO2_ENABLE          BIT(1)
#define AXP22X_ADC_GPIO3_ENABLE          BIT(0)
