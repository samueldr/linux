...
int de_rtmx_set_overlay_reg_base(unsigned int sel, unsigned int chno,
	void *base);
int de_rtmx_set_lay_cfg(unsigned int sel, unsigned int chno,
	unsigned int layno, struct __lay_para_t *cfg);
...
int de_rtmx_set_lay_laddr(unsigned int sel, unsigned int chno,
	unsigned int layno, unsigned char fmt, unsigned char yv12_4k_en,
	struct de_rect crop, unsigned int *size, unsigned int *align,
	enum de_3d_in_mode trdinmode, unsigned int *addr, unsigned char *haddr);
int de_rtmx_get_3d_in(unsigned char fmt, struct de_rect crop, struct de_fb *size,
...
int de_rtmx_get_3d_in_single_size(enum de_3d_in_mode inmode, struct de_rect64 *size);
...
int de_rtmx_set_colorkey(unsigned int sel, unsigned char ck_no,
	...
	unsigned char ck_green_match, unsigned char ck_blue_match,
	unsigned int ck_max, unsigned int ck_min);
...
int de_rtmx_set_display_size(unsigned int sel,
...
int de_rtmx_get_lay_enabled(unsigned int sel,
	unsigned int chno, unsigned int layno);
...
int de_rtmx_get_lay_win(unsigned int sel, unsigned int chno,
	unsigned int layno, struct disp_rect *win);
int de_rtmx_get_lay_format(unsigned int sel, unsigned int chno,
	unsigned int layno);
int de_rtmx_get_display_size(unsigned int sel,
	unsigned int *width, unsigned int *height);
