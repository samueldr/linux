 ...
 *				unsigned int *coef)
 *{
 *	aw_memcpy_toio(&gsu_dev[sel][chno-VI_CHN_NUM]->hcoeff, coef,
			...
			struct scaler_para *para)
{
	...
	aw_memcpy_toio(((void *)&gsu_dev[sel][chno_t]->hcoeff),
