/*
 * drivers/video/sunxi/disp2/disp/lcd/FT8021_TV097WXM_LH0.c
 *
...
&lcd0 {
	lcd_used            = <1>;
	status              = "okay";
	lcd_driver_name     = "FT8021_TV097WXM_LH0";
	lcd_backlight       = <50>;
	lcd_if              = <4>;
...
struct __lcd_panel FT8021_TV097WXM_LH0_mipi_panel = {
	/* panel driver name, must mach the name of lcd_drv_name in sys_config.fex */
	.name = "FT8021_TV097WXM_LH0",
	.func = {
