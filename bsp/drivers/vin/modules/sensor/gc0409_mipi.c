/*
 * A V4L2 driver for GC0409 Raw cameras.
 *
...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for GC0409 sensors");
MODULE_LICENSE("GPL");

#define MCLK              (24*1000*1000)
#define V4L2_IDENT_SENSOR 0x0409
...
#define SENSOR_NAME "gc0409_mipi"
...
static int sensor_s_gain(struct v4l2_subdev *sd, unsigned int gain_val)
{
	...
	if ((All_gain >= ANALOG_GAIN_1) && (All_gain < ANALOG_GAIN_2)) {
	...
	} else if (All_gain >= ANALOG_GAIN_2) {
