...
#define SENSOR_NAME "imx278_2lane_mipi"
#define SENSOR_NAME_2 "imx278_2lane_mipi_2"
...
static struct regval_list sensor_1080p60_2lane_regs[] = {
	{0x0100, 0x00},
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x01},
...
static struct regval_list sensor_1080p30_2lane_regs[] = {
	{0x0100, 0x00},
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x01},
...
static struct sensor_win_size sensor_win_sizes[] = {

	 {
	   ...
	   .gain_min	 = 16,
	   .gain_max	 = (128<<4),
	   .regs		 = sensor_1080p60_2lane_regs,
	   .regs_size  = ARRAY_SIZE(sensor_1080p60_2lane_regs),
	   .set_size	 = NULL,
	 },

	 {
	   ...
	   .gain_min	   = 16,
	   .gain_max	   = (128<<4),
	   .regs		   = sensor_1080p30_2lane_regs,
	   .regs_size  = ARRAY_SIZE(sensor_1080p30_2lane_regs),
	   .set_size	   = NULL,
	 },
