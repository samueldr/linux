/*
 * A V4L2 driver for ov2775_mipi Raw cameras.
 *
...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for OV2775 sensors");
MODULE_LICENSE("GPL");

#define MCLK              (24*1000*1000)
#define V4L2_IDENT_SENSOR  0x2775
...
#define SENSOR_NAME "ov2775_mipi"
#define SENSOR_NAME_2 "ov2775_mipi_2"
...
static struct regval_list sensor_1080p30fpshdr_mipi_regs[] = {
	{0x3013, 0x01},
	{REG_DLY, 0x10},
...
static int ov2775_mipi_sensor_vts;
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	sensor_write(sd, 0x315b, ((digi_gain*16/11) & 0xff));
	sensor_write(sd, 0x315a, (digi_gain*16/11) >> 8);
	sensor_write(sd, 0x315d, (digi_gain & 0xff));
	sensor_write(sd, 0x315c, digi_gain >> 8);
...
static int sensor_s_sw_stby(struct v4l2_subdev *sd, int on_off)
{
	...
	ret = sensor_read(sd, 0x3012, &rdval);
	if (ret != 0)
		return ret;

	if (on_off == STBY_ON)
		ret = sensor_write(sd, 0x3012, rdval & 0xfe);
	else
		ret = sensor_write(sd, 0x3012, rdval | 0x01);
 ...
 *		.gain_min   = 1<<4,
 *		.gain_max   = 32<<4,
 *		.regs       = sensor_1080phdr_regs,
 *		.regs_size  = ARRAY_SIZE(sensor_1080phdr_regs),
 *		.set_size   = NULL,
 *	},
 */
	/*1080pfsin*/
	{
		...
		.gain_min   = 1<<4,
		.gain_max   = 32<<4,
		.regs       = sensor_1080p30fpshdr_mipi_regs,
		.regs_size  = ARRAY_SIZE(sensor_1080p30fpshdr_mipi_regs),
		.set_size   = NULL,
	},
};
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	ov2775_mipi_sensor_vts = wsize->vts;
