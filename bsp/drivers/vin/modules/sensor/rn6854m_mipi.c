...
static struct regval_list sensor_ch0_PAL_ch1_720p_25fps_regs[] = {

	{0x81, 0x03}, // turn on video decoder
	{0xA3, 0x04},
	{0xDF, 0x01}, // ch0 CVBS ch1 720P
	{0xD3, 0x50},
	{0x88, 0x00},
	{0xF6, 0x00},
	...
	{0x6C, 0x13}, // disable ch output; turn on ch
	{0x6D, 0x01}, // open ch0 field num, 1 for odd, 2 for even
	{0x06, 0x7C}, // 4 lanes
	{0x21, 0x01}, // enable hs clock
	{0x34, 0x06},
	{0x35, 0x0B},
	{0x78, 0x68}, // Y/C counts for ch0
	{0x79, 0x01}, // Y/C counts for ch0
...
static struct regval_list sensor_cvbs_P_1ch_interlace_25fps_regs[] = {
	...
	{0xFF, 0x08}, // switch to mipi csi1
	{0x04, 0x03}, // csi1 and tx1 reset
	{0x6C, 0x11}, // disable ch output; turn on ch
	{0x6D, 0x01}, // open ch0 field num, 1 for odd, 2 for even
	{0x06, 0x7C}, // 4 lanes
	{0x21, 0x01}, // enable hs clock
	{0x34, 0x06},
...
static struct regval_list sensor_cvbs_P_4ch_interlace_25fps_regs[] = {
	...
	{0xFF, 0x08}, // switch to mipi csi1
	{0x04, 0x03}, // csi1 and tx1 reset
	{0x6C, 0x1F}, // disable ch output; turn on ch
	{0x6D, 0x55}, // open 4ch field num, 1 for odd, 2 for even
	{0x06, 0x7C}, // 4 lanes
	{0x21, 0x01}, // enable hs clock
	{0x34, 0x06},
	{0x35, 0x0B},
	{0x78, 0x68}, // Y/C counts for ch0
	{0x79, 0x01}, // Y/C counts for ch0
	{0x7A, 0x68}, // Y/C counts for ch1
	{0x7B, 0x01}, // Y/C counts for ch1
	{0x7C, 0x68}, // Y/C counts for ch2
	{0x7D, 0x01}, // Y/C counts for ch2
	{0x7E, 0x68}, // Y/C counts for ch3
	{0x7F, 0x01}, // Y/C counts for ch3
...
static struct regval_list sensor_cvbs_N_4ch_interlace_25fps_regs[] = {
...
static struct regval_list sensor_cvbs_N_4ch_frame_mode_25fps_regs[] = {
...
static struct regval_list sensor_cvbs_P_4ch_frame_mode_25fps_regs[] = {
...
static struct regval_list sensor_720p_regs[] = {
	...
	{0x5A, 0x23}, // data for extended register
	{0x58, 0x01}, // enable extended register write
	{0x51, 0xE1}, // H-scaling control
	{0x52, 0x88}, // enable H-scaling control
	{0x53, 0x12}, // H-scaling control
	{0x5B, 0x07}, // cropping
	{0x5E, 0x0B},
	{0x6A, 0x82},
	{0x28, 0x92},
	...
	{0x04, 0x80},
	{0x05, 0x04},
	{0x57, 0x23}, // saturation
	{0x68, 0x32}, // hue
	{0x37, 0x33}, // sharpness
	{0x61, 0x6C}, // black/white stretch

};

static struct regval_list sensor_turn_on_video_decoder[] = {

	{0x81, 0x0F}, // turn on video decoder
	{0xA3, 0x04},
	{0xDF, 0x03}, // enable CVBS format
	{0xD3, 0x50},
	{0x88, 0x00},
	{0xF6, 0x00},
...
static struct regval_list sensor_mipi_link_1[] = {
...
static struct regval_list sensor_mipi_link_2[] = {
...
static struct regval_list sensor_cvbs_P_frame_mode_regs[] = {
...
static struct regval_list sensor_cvbs_N_frame_mode_regs[] = {
...
static struct sensor_win_size sensor_win_sizes[] = {
	  ...
	  .mipi_bps = 567*1000*1000,
	  .fps_fixed = 25,
	  .regs = sensor_cvbs_N_4ch_frame_mode_25fps_regs,
	  .regs_size = ARRAY_SIZE(sensor_cvbs_N_4ch_frame_mode_25fps_regs),
	  .set_size = NULL,
	  },
	  {
	  .width = 720,
	  ...
	  .mipi_bps = 567*1000*1000,
	  .fps_fixed = 25,
	  .regs = sensor_cvbs_P_4ch_frame_mode_25fps_regs,
	  .regs_size = ARRAY_SIZE(sensor_cvbs_P_4ch_frame_mode_25fps_regs),
	  .set_size = NULL,
	  },
	  ...
	  .mipi_bps = 567*1000*1000,
	  .fps_fixed = 25,
	  .regs = sensor_cvbs_P_4ch_interlace_25fps_regs,
	  .regs_size = ARRAY_SIZE(sensor_cvbs_P_4ch_interlace_25fps_regs),
	  .set_size = NULL,
	  },
	  {
	  .width = 720,
	  ...
	  .mipi_bps = 567*1000*1000,
	  .fps_fixed = 25,
	  .regs = sensor_cvbs_N_4ch_interlace_25fps_regs,
	  .regs_size = ARRAY_SIZE(sensor_cvbs_N_4ch_interlace_25fps_regs),
	  .set_size = NULL,
	  },
