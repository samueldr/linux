...
/* Interrupt and config */
	...
	/* --------General control */
	{
		...
		.val = 0x16,       /* Scanperiod : 200ms(10111) */
	},
	{
	...
	/* --------AFE Control */
	{
		...
		.val = 0x10,       /* CSx pin during sleep mode : 1 HZ */
	},
	{
	...
	},
	{
		...
		.val = 0x01,       /* Analog Range(ph0/1) : Large */
	},
	{
	...
	},
	{
		...
		.val = 0x17,       /* Sampling Freq(ph2/3) : 83.33khz(01000), Resolution(ph2/3) : 128(100) */
	},
	{
		.reg = SX932x_AFE_PH0_REG,   /* 0x28 */
		.val = 0x3D,       /* CS2:GND CS1:GND CS0 :input */
	},
	{
		.reg = SX932x_AFE_PH1_REG,     /* 0x29 */
		.val = 0x27,       /* CS2:shield CS1:input  CS0 :shield */
	},
	{
		.reg = SX932x_AFE_PH2_REG,   /* 0x2A */
		.val = 0x1F,       /* CS2:shield CS1:input CS0 :shield */
	},
	{
		.reg = SX932x_AFE_PH3_REG,   /* 0x2B */
		.val = 0x37,       /* CS2:HZ CS1:HZ CS0 :HZ */
	},
	{
	...
	},
	{
		...
		.val = 0x06,       /* Analg gain : x1(1000) */
	},
	/* --------PROX control */
	{
		.reg = SX932x_PROX_CTRL0_REG,  /* 0x30 */
		.val = 0x0A,       /* Digital Gain(ph0/1) : off(001) Digital Filter(ph0/1) : 1-1/2(001) */
	},
	{
		.reg = SX932x_PROX_CTRL1_REG,  /* 0x31 */
		.val = 0x08,       /* Digital Gain(ph2/3) : off(001) Digital Filter(ph2/3) : 1-1/2(001) */
	},
	{
	...
	},
	{
		...
		.val = 0x0B,       /* AVGFREEZEDIS : on(0) ,AVGNEGFILT :1-1/2(001) ,AVGPOSFILT : 1-1/256(100) */
	},
	{
		.reg = SX932x_PROX_CTRL5_REG,  /* 0x35 */
		.val = 0x10,       /* FARCOND: PROXDIFF < (THRESH.HYST), HYST : None, CLOSEDEB : off ,FARDEB : off */
	},
	{
		.reg = SX932x_PROX_CTRL6_REG,  /* 0x36 */
		.val = 0x24,       /* Prox Theshold(ph0/1) : 200 */
	},
	{
		.reg = SX932x_PROX_CTRL7_REG,  /* 0x37 */
		.val = 0x24,       /* Prox Theshold(ph2/3) : 200 */
	},
	/* --------Advanced control */
	{
		.reg = SX932x_ADV_CTRL0_REG,/*0x40*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL1_REG,/*0x41*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL2_REG,/*0x42*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL3_REG,/*0x43*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL4_REG,/*0x44*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL5_REG,/*0x45*/
		.val = 0x05,
	},
	{
		.reg = SX932x_ADV_CTRL6_REG,/*0x46*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL7_REG,/*0x47*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL8_REG,/*0x48*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL9_REG,/*0x49*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL10_REG,/*0x4A*/
		.val = 0x40,
	},
	{
		.reg = SX932x_ADV_CTRL11_REG,/*0x4B*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL12_REG,/*0x4C*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL13_REG,/*0x4D*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL14_REG,/*0x4E*/
		.val = 0x80,
	},
	{
		.reg = SX932x_ADV_CTRL15_REG,/*0x4F*/
		.val = 0x0C,
	},
	{
		.reg = SX932x_ADV_CTRL16_REG,/*0x50*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL17_REG,/*0x51*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL18_REG,/*0x52*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL19_REG,/*0x53*/
		.val = 0x00,
	},
	{
		.reg = SX932x_ADV_CTRL20_REG,/*0x54*/
		.val = 0x00,
	},
	{
		.reg = SX932x_CPSRD,/*0x60*/
		.val = 0x01,
	},
	/* --------Sensor enable */
	{
		.reg = SX932x_CTRL1_REG,    /* 0x11 */
		.val = 0x26,       /* enable PH2 PH1*/
	},
};
...
struct sx93XX {
	...
	* or does not work properly */
	...
	struct pinctrl_state		*sx932x_active;
	struct pinctrl_state		*sx932x_sleep;
	struct regulator			 *sx932x_vdd;
};

void sx93XX_2_suspend(psx93XX_t this);
void sx93XX_2_resume(psx93XX_t this);
int sx93XX_2_IRQ_init(psx93XX_t this);
int sx93XX_2_remove(psx93XX_t this);
