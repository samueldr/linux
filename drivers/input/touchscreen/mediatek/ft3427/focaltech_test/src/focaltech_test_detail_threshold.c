...
void OnInit_DThreshold_ForceTouch_SCapRawDataTest(char *strIniFile)
{
    ...
    GetPrivateProfileString("Basic_Threshold",
                            "ForceTouch_SCapRawDataTest_OFF_Min", "150", str,
                            strIniFile);
    MinValue = fts_atoi(str);
    GetPrivateProfileString("Basic_Threshold",
...
void OnInit_DThreshold_ForceTouch_SCapCbTest(char *strIniFile)
{
    ...
    //////////////////ON
    GetPrivateProfileString("Basic_Threshold", "ForceTouch_SCapCbTest_ON_Min",
                            "0", str, strIniFile);
    MinValue = fts_atoi(str);
    ...
    //////////////////OFF
    GetPrivateProfileString("Basic_Threshold", "ForceTouch_SCapCbTest_OFF_Min",
                            "0", str, strIniFile);
    MinValue = fts_atoi(str);
