...
TEST_ERR:
    ...
    *bTestResult = false;
    FTS_TEST_DBG("\n\n//RawData Test is NG!");
    TestResultLen +=
        sprintf(TestResult + TestResultLen, " RawData Test is NG. \n\n");
    return ReCode;
...
TEST_ERR:
    *bTestResult = false;
    FTS_TEST_DBG("\n\n//SCap RawData Test is NG!");
    TestResultLen +=
        sprintf(TestResult + TestResultLen, " SCap RawData Test is NG. \n\n");
    return ReCode;
}
...
TEST_ERR:
    ...
    *bTestResult = false;
    FTS_TEST_DBG("\n\n//SCap CB Test Test is NG!");
    TestResultLen +=
        sprintf(TestResult + TestResultLen, " SCap CB Test is NG. \n\n");
    return ReCode;
}
...
TEST_ERR:
    ...
    *bTestResult = false;
    FTS_TEST_DBG("		//Panel Differ Test is NG!");
    TestResultLen +=
        sprintf(TestResult + TestResultLen, " Panel Differ Test is NG. \n\n");
    return ReCode;
}
