...
extern unsigned char CTPM_FW_GX[]; 
extern unsigned char CTPM_FW_TXD[];
//hebiao@wind-mobi.com end at 20170101 for guoxian and txd compatible
extern unsigned char CTPM_FW_HS[];          // wangbing@wind-mobi.com 20170502
extern unsigned char CTPM_FW_YKL[];          // wangjun@wind-mobi.com 20170522

extern unsigned char aucFW_PRAM_BOOT_onsell[];
extern struct fts_Upgrade_Info fts_updateinfo_curr;
extern struct fts_Upgrade_Fun fts_updatefun_curr_onsell;
extern struct ft_chip_t chip_types_onsell;

#if FTS_AUTO_UPGRADE_EN
extern struct workqueue_struct *touch_wq_onsell;
extern struct work_struct fw_update_work_onsell;
#endif
