...
#define CTP_ESD_PROTECT							0//tuwenzan@wind-mobi.com add at 20160602
/*********************Custom Define end*************************************************/
...
#define FTS_GESTRUE_EN 							1  // lihaiyan 开启手势模式
#define MTK_EN 									1
#define FTS_APK_DEBUG
#define SYSFS_DEBUG
//#define TPD_AUTO_UPGRADE  //tuwenzan@wind-mobi.com add 20160408
...
#define FTS_Vendor_1_ID		0xA6//Ofilm TP VID = 0x51   FT3427 VID == 0xA6
#define FTS_Vendor_2_ID		0x8D//Ofilm TP new VID      FT3327 VID == 0xDA  0x8D
#define FTS_Vendor_3_ID		0xE4   //A7//E188 yashi TP VID     FT3427 VID == 0xB5  0xA7 //lihaiyan@wind-mobi.com 20160802   FT3427 VID=F0
...
extern struct i2c_client *fts_i2c_client_onsell;
extern struct input_dev *fts_input_dev_onsell;
...
extern int fts_i2c_read_onsell(struct i2c_client *client, char *writebuf,int writelen, char *readbuf, int readlen);
extern int fts_i2c_write_onsell(struct i2c_client *client, char *writebuf, int writelen);
...
extern int fts_ctpm_fw_upgrade_with_app_file(struct i2c_client *client,
				       char *firmware_name);
extern int fts_ctpm_auto_clb_onsell(struct i2c_client *client);
extern int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client, u8 boot_id);
extern int fts_ctpm_get_i_file_ver(u8 tp_vendor_id); //tuwenzan@wind-mobi.com modify at 20160506
extern int fts_remove_sysfs_onsell(struct i2c_client *client);
extern void fts_release_apk_debug_channel_onsell(void);
extern int fts_ctpm_auto_upgrade_onsell(struct i2c_client *client);
#if FT_ESD_PROTECT
extern void esd_switch(s32 on);
#endif
extern void fts_reset_tp(int HighOrLow);
extern int fts_create_sysfs_onsell(struct i2c_client *client);
// Apk and ADB functions
extern int fts_create_apk_debug_channel_onsell(struct i2c_client * client);
