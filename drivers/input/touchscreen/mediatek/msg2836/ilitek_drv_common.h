...
#define DEVICE_DRIVER_RELEASE_VERSION   ("7.0.0.0")
 ...
 * For running on Rockchip platform (ex. RK3288), please define the compile option ROCKCHIP (it should be defined with QCOM platform compile option)
 */
//#define CONFIG_TOUCH_DRIVER_RUN_ON_SPRD_PLATFORM
//#define CONFIG_TOUCH_DRIVER_RUN_ON_QCOM_PLATFORM
#define CONFIG_TOUCH_DRIVER_RUN_ON_MTK_PLATFORM  //zhangbeibei@wind-mobi.com 20170725 change
//#define ROCKCHIP
 ...
 */
#define CONFIG_PLATFORM_USE_ANDROID_SDK_6_UPWARD //zhangbeibei@wind-mobi.com 20170725 change
...
#define CONFIG_ENABLE_CHIP_TYPE_MSG28XX       // This compile option can be used for MSG28XX/MSG58XX/MSG58XXA/ILI2117A/ILI2118A zhangbeibei@wind-mobi.com 20170725 change
 ...
 * By default, this compile option is disabled.
 */
#define CONFIG_ENABLE_REGULATOR_POWER_ON  //zhangbeibei@wind-mobi.com 20170725 change
 ...
 * By default, this compile option is disabled.
 */
#define CONFIG_ENABLE_DMA_IIC  //zhangbeibei@wind-mobi.com 20170725 change
...
#define CONFIG_ENABLE_APK_PRINT_FW_LOG (1)
 ...
 * By default, this compile option is disabled.
 */
#define CONFIG_UPDATE_FIRMWARE_BY_SW_ID  //zhangbeibei@wind-mobi.com 20170725
...
#define CHIP_TYPE_MSG28XX   (0xBF) // EX. MSG2833/MSG2835/MSG2836/MSG2840/MSG2856/MSG5846
...
#else
#define TOUCH_SCREEN_X_MAX   (720)  //LCD_WIDTH//zhangbeibei@wind-mobi.com 20170725
#define TOUCH_SCREEN_Y_MAX   (1440) //LCD_HEIGHT//zhangbeibei@wind-mobi.com 20170725
#endif
...
#define CONFIG_TOUCH_DRIVER_DEBUG_LOG_LEVEL (0)    // modify by wangbing@wind-mobi.com 20170801
