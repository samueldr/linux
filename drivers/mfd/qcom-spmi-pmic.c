...
static void pmic_spmi_load_revid(struct regmap *map, struct device *dev, struct qcom_spmi_pmic *pmic)
{
	int ret, i;
	...
	if (i != ARRAY_SIZE(pmic_spmi_id_table))
		pmic->name = pmic_spmi_id_table[i].compatible;
