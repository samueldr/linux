...
//zhangkaiyuan@wind-mobi.com 20170327 begin
#ifdef CONFIG_HAS_HEADSET_SWITCH
struct work_struct headswitch;
#endif
//zhangkaiyuan@wind-mobi.com 20170327 end
...
//zhangkaiyuan@wind-mobi.com 20170327 begin
#ifdef CONFIG_HAS_HEADSET_SWITCH
struct pinctrl_state *pins_head;
struct pinctrl_state *pins_head2;
#endif
//zhangkaiyuan@wind-mobi.com 20170327  end
#endif
...
////zhangkaiyuan@wind-mobi.com 20170327 begin
#ifdef CONFIG_HAS_HEADSET_SWITCH
static void headswitch_work_callback(struct work_struct *work)
{
	...
	if(cur_eint_state==1)
	{
	 ...
	 pins_head2 = pinctrl_lookup_state(accdet_pinctrl1, "headphone2_high");
	 pinctrl_select_state(accdet_pinctrl1, pins_head2);
	 msleep(800);
	 pins_head = pinctrl_lookup_state(accdet_pinctrl1, "headphone_high");
	 pinctrl_select_state(accdet_pinctrl1, pins_head);
	 printk("liukangpine high\n");
		 
	}
	else
	{
	 pins_head = pinctrl_lookup_state(accdet_pinctrl1, "headphone_low");
	 pinctrl_select_state(accdet_pinctrl1, pins_head);
	 pins_head2 = pinctrl_lookup_state(accdet_pinctrl1, "headphone2_low");
	 pinctrl_select_state(accdet_pinctrl1, pins_head2);
	 printk("liukangpine low\n");
	}
...
int mt_accdet_probe(struct platform_device *dev)
{
	...
	//zhangkaiyuan@wind-mobi.com 20170327 begin
	#ifdef CONFIG_HAS_HEADSET_SWITCH
    INIT_WORK(&headswitch, headswitch_work_callback);
	#endif
    ////zhangkaiyuan@wind-mobi.com 20170327 end
