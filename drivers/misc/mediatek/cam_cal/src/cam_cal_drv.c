...
//dingyisheng@wind-mobi.com 20170817 begin
#if (defined CONFIG_WIND_DEF_PRO_E260L_WW)||(defined CONFIG_WIND_DEF_PRO_E260L)
		g_curBusIdx = BUS_ID_SUB;
#else
        g_curBusIdx = BUS_ID_MAIN;
#endif
//dingyisheng@wind-mobi.com 20170817 end
