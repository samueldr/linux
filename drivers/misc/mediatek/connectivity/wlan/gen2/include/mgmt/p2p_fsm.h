...
//add by xulinchao@wind-mobi.com set max number of hostpot to 8 2016.01.19 start
#define P2P_MAXIMUM_CLIENT_COUNT                    8
//add by xulinchao@wind-mobi.com set max number of hostpot to 8 2016.01.19 end
