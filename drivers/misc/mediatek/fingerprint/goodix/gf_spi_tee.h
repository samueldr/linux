...
#define GF_INPUT_SINGLE_CLICK_KEY  KEY_DEL_EOL
#define GF_INPUT_DOUBLE_CLICK_KEY  KEY_DEL_EOS
#define GF_INPUT_LONG_PRESS_KEY  KEY_INS_LINE
//modified by lizusheng@wind-mobi.com for Navigation 20161125 end

#define GF_NAV_INPUT_CLICK		KEY_DEL_EOL
#define GF_NAV_INPUT_DOUBLE_CLICK	KEY_DEL_EOS
#define GF_NAV_INPUT_LONG_PRESS		KEY_INS_LINE
