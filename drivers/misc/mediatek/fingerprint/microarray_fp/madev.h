...
#define FINGERPRINT_SWIPE_UP 			KEY_UP
#define FINGERPRINT_SWIPE_DOWN 			KEY_DOWN
#define FINGERPRINT_SWIPE_LEFT 			KEY_LEFT
#define FINGERPRINT_SWIPE_RIGHT 		KEY_RIGHT
#define FINGERPRINT_TAP 				KEY_DEL_EOL
#define FINGERPRINT_DTAP				KEY_DEL_EOS
#define FINGERPRINT_LONGPRESS 			KEY_INS_LINE
