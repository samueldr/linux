...
//---------------------------------------------------------------------------------
#define SF_DRV_VERSION "v2.2.16-2018-04-18"
...
//hebiao@wind-mobi.com 20161105 end
	...
	//err = 0;//add bruce test
 	xprintk(KERN_INFO, "sunwave probe read chip id test, err = 0x%x\n",err);
    if (err < 0) {
