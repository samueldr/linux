...
//extern int flashEnable_KTD2684_2(void);
//extern int flashDisable_KTD2684_2(void);
//extern int setDuty_KTD2684_2(int duty);
...
static int constant_flashlight_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	PK_DBG
	    ("KTD2684_constant_flashlight_ioctl() line=%d ior_shift=%d, iow_shift=%d iowr_shift=%d arg=%d\n",
	...
	case FLASH_IOC_SET_DUTY:
		PK_DBG("CIEL_TEST_FLASHLIGHT_DUTY: %d\n", (int)arg);
	// zhaozhensen@wind-mobi.com 20161017 begin
		//	m_duty2 = (int)arg;
	// zhaozhensen@wind-mobi.com 20161017 end
		FL_dim_duty(arg);
	...
	case FLASH_IOC_SET_ONOFF:
		PK_DBG("CIEL_TEST_FLASHLIGHT_ONOFF: %d\n", (int)arg);
		if (arg == 1) {
