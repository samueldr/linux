...
//dingyisheng@wind-mobi.com 20170810 ldo 2.9v for AVDD begin
#if (defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
#define CUST_AVDD_LDO   (MAIN2_DVDD - AVDD + 1)
//dingyisheng@wind-mobi.com 20170810 ldo 2.9v for AVDD end
...
PowerCust PowerCustList = {
	{
       ...
       /*******zhaozhensen@wind-mobi.com 20161012 begin**************/
	...
	//dingyisheng@wind-mobi.com 20170810 ldo 2.9v for AVDD begin
#if (defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
		{GPIO_SUPPORTED, GPIO_MODE_GPIO, Vol_High},	/* AVDD_LDO; */
#endif
	//dingyisheng@wind-mobi.com 20170810 ldo 2.9v for AVDD end
...
PowerUp PowerOnList = {
	{
	 ...
	 {SENSOR_DRVNAME_OV16825_MIPI_RAW,
	  ...
	  //yeshaobo@wind-mobi.com 20170324 begin
	  {SENSOR_DRVNAME_OV13855_MIPI_RAW,
	  {
	   ...
	   {RST, Vol_High, 0},
	    ...
	    {SENSOR_DRVNAME_HI1332_MIPI_RAW,
	  {
	   {SensorMCLK, Vol_High, 0},
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	  ...
	  //yeshaobo@wind-mobi.com 20170324 end
	 ...
	 {SENSOR_DRVNAME_OV8858_MIPI_RAW,
	  ...
	  // zhaozhensen@wind-mobi.com 20161010 begin
	  ...
	  {SENSOR_DRVNAME_IMX258_MIPI_RAW_GZ,
	  {
	   {SensorMCLK, Vol_High, 0},
	   {PDN, Vol_Low, 0},
	   {RST, Vol_Low, 0},
	...
	{SENSOR_DRVNAME_S5K3M2_MIPI_RAW, 		
	  ...
	  {SENSOR_DRVNAME_HI846_MIPI_RAW_HLT,
	  {
	   {SensorMCLK, Vol_High, 0},
	   {PDN, Vol_Low, 0},
	   {RST, Vol_Low, 0},
	 ...
	 //{AFVDD, Vol_2800, 5},
	   ...
	   //yeshaobo@wind-mobi.com 20170804 begin
	   {SENSOR_DRVNAME_OV8856_MIPI_RAW_HLT,
	  {
	   {SensorMCLK, Vol_High, 0},
	   {DOVDD, Vol_1800, 1},
	   {AVDD, Vol_2800, 1},
	 ...
	 //{AFVDD, Vol_2800, 5},
	   ...
	   //yeshaobo@wind-mobi.com 20170804 end
	  
#if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
           {SENSOR_DRVNAME_S5K3L8_MIPI_RAW_GZ,
          {
           {SensorMCLK, Vol_High, 0},
           {DOVDD, Vol_1800, 0},
           {AVDD, Vol_2800, 0},
          ...
          {SENSOR_DRVNAME_S5K3P3SX_MIPI_RAW,
          {
		   ...
		   {SENSOR_DRVNAME_S5K3P3_MIPI_RAW,
		   {
			...
			{RST, Vol_High, 0},
              ...
              {SENSOR_DRVNAME_S5K3L8_MIPI_RAW_OFG,
          {
           {SensorMCLK, Vol_High, 0},
           {DOVDD, Vol_1800, 0},
           {AVDD, Vol_2800, 0},
		    ...
		    {SENSOR_DRVNAME_OV16880_MIPI_RAW,
          {
           ...
           {RST, Vol_High, 0},
		  	  ...
		  	  {SENSOR_DRVNAME_OV16880_MIPI_RAW_HLT,
          {
           {SensorMCLK, Vol_High, 0},
           {DOVDD, Vol_1800, 0},
           {AVDD, Vol_2800, 0},
...
//dingyisheng@wind-mobi.com 20170823 begin
struct pinctrl_state *cam1_ldo_vcama_h = NULL;
struct pinctrl_state *cam1_ldo_vcama_l = NULL;
//dingyisheng@wind-mobi.com 20170823 end
...
//dingyisheng@wind-mobi.com 20170823 begin
	cam1_ldo_vcama_h = pinctrl_lookup_state(camctrl, "cam1_ldo_vcama_1");
	if (IS_ERR(cam1_ldo_vcama_h)) {
		ret = PTR_ERR(cam1_ldo_vcama_h);
		PK_DBG("%s : pinctrl err, cam1_ldo_vcama_h\n", __func__);
	}

	cam1_ldo_vcama_l = pinctrl_lookup_state(camctrl, "cam1_ldo_vcama_0");
	if (IS_ERR(cam1_ldo_vcama_l)) {
		ret = PTR_ERR(cam1_ldo_vcama_l);
		PK_DBG("%s : pinctrl err, cam1_ldo_vcama_l\n", __func__);
	}
//dingyisheng@wind-mobi.com 20170823 end
...
//dingyisheng@wind-mobi.com 20170823 begin
	case AVDD:
		...
		if (Val == 0 && !IS_ERR(cam_ldo_vcama_l))
			...
			PK_ERR("%s : pinctrl err, PinIdx %d, Val %d, AVDD\n", __func__,PinIdx ,Val);
		}else if(PinIdx == 1){
		if (Val == 0 && !IS_ERR(cam1_ldo_vcama_l))
			pinctrl_select_state(camctrl, cam1_ldo_vcama_l);
		else if (Val == 1 && !IS_ERR(cam1_rst_h))
			pinctrl_select_state(camctrl, cam1_ldo_vcama_h);
		else
			PK_ERR("%s : pinctrl err, PinIdx %d, Val %d, AVDD\n", __func__,PinIdx ,Val);
		}
		break;
...
BOOL hwpoweron(PowerInformation pwInfo, char *mode_name)
{
	...
	#if defined CONFIG_WIND_CAM_SINGLE_LDO_SUPPORT
		if(pinSetIdx == 0){
				if (PowerCustList.PowerCustInfo[CUST_AVDD_LDO].Gpio_Pin == GPIO_SUPPORTED){
				    if (mtkcam_gpio_set(pinSetIdx, pwInfo.PowerType, PowerCustList.PowerCustInfo[CUST_AVDD_LDO].Voltage)) {
	...
	#elif defined CONFIG_WIND_CAM_DOUBLE_LDO_SUPPORT
	...
	//dingyisheng@wind-mobi.com 20170810 ldo 2.9v for AVDD end
		...
		if (pinSetIdx == 2) {
			if (PowerCustList.PowerCustInfo[CUST_DVDD].Gpio_Pin == GPIO_UNSUPPORTED) {
				...
				/***zhenglihong@wind-mobi.com 20161212 begin***/
#if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
...
#endif
	     	/***zhenglihong@wind-mobi.com 20161212 end***/
			} else {
		...
		if (pinSetIdx == 0) {
			...
			ISP_MCLK1_EN(TRUE);
		          ...
		          ISP_MCLK1_EN(TRUE); //zhenglihong@wind-mobi.com 20170109 
		} else {
...
{	
	...
	if (pwInfo.PowerType == AVDD) {
		...
		if(pinSetIdx == 0){
		    if (PowerCustList.PowerCustInfo[CUST_AVDD_LDO].Gpio_Pin == GPIO_SUPPORTED){
			if (mtkcam_gpio_set(pinSetIdx, AVDD, 1-PowerCustList.PowerCustInfo[CUST_AVDD_LDO].Voltage)) {
 ...
 //dingyisheng@wind-mobi.com 20170810 ldo 2.9v for AVDD end
		...
		if (pinSetIdx == 2) {
			...
			if (PowerCustList.PowerCustInfo[CUST_SUB_DVDD].Gpio_Pin == GPIO_UNSUPPORTED) {
				//ranyanhao@wind-mobi.com 20161019 begin
				if (TRUE != _hwPowerDown(DVDD)) {
				//ranyanhao@wind-mobi.com 20161019 end
...
//zhenglihong@wind-mobi.com 20170111 begin
#if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
	if (0 == pinSetIdx) {
		//yeshaobo@mobi-wind.com 20170325 begin
		if ( !((0 == strcmp(currSensorName,"s5k3l8mipirawgz")) || (0 == strcmp(currSensorName,"s5k3p3sxmipiraw")) || (0 == strcmp(currSensorName,"s5k3l8mipiraofg")) || (0 == strcmp(currSensorName,"ov16880mipiraw")) || (0 == strcmp(currSensorName,"ov13855mipiraw")))) {
                      goto _kdCISModulePowerOn_exit_;
		}
		//yeshaobo@mobi-wind.com 20170325 end
	} else if (2 == pinSetIdx) {
                  if ( !((0 == strcmp(currSensorName,"hi846mipiraw")) || (0 == strcmp(currSensorName,"ov8856mipiraw")) || (0 == strcmp(currSensorName,"hi846mipirawhlt")) )) {
                      goto _kdCISModulePowerOn_exit_;
		}
	} else if (1 == pinSetIdx){
	//yeshaobo@wind-mobi.com 20170807 begin
                  if ( !((0 == strcmp(currSensorName,"hi553mipiraw")) || (0 == strcmp(currSensorName,"s5k5e8yxmipiraw")) || (0 == strcmp(currSensorName,"hi846mipiraw"))|| (0 == strcmp(currSensorName,"ov8856mipirawhlt")) || (0 == strcmp(currSensorName,"s5k3p3mipiraw")) || (0 == strcmp(currSensorName,"hi1332mipiraw"))||(0 == strcmp(currSensorName,"ov16880mipirawhlt")))) {
                      goto _kdCISModulePowerOn_exit_;
		}
	//yeshaobo@wind-mobi.com 21070807 end
	} else {
	       goto _kdCISModulePowerOn_exit_;
	}
#endif
//zhenglihong@wind-mobi.com 20170111 end
...
#endif
//yeshaobo@wind-mobi.com 20170329 begin
		for (pwListIdx = 0; pwListIdx < 30; pwListIdx++) {
//yeshaobo@wind-mobi.com 20170329 end
		...
		if(has_mipi_switch){
#if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
           	if (DUAL_CAMERA_MAIN_SENSOR == SensorIdx || DUAL_CAMERA_MAIN_2_SENSOR == SensorIdx) {
		...
		//yeshaobo@wind-mobi.com 20170411 begin
		for (pwListIdx = 0; pwListIdx < 30; pwListIdx++) {
		//yeshaobo@wind-mobi.com 20170411 end
			if (currSensorName && (PowerOnList.PowerSeq[pwListIdx].SensorName != NULL)
			    && (0 ==
				strcmp(PowerOnList.PowerSeq[pwListIdx].SensorName,
				       currSensorName))) {
