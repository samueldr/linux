...
// zhaozhensen@wined-mobi.com 20161122 for hi553_otp problem begin
extern int iReadRegI2C_OTP(u8 *a_pSendData , u16 a_sizeSendData, u8 *a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
// zhaozhensen@wined-mobi.com 20161122 for hi553_otp problem end
/****************************   Modify end    *******************************************/
// zhaozhensen@wind-mobi.com 20170210 begin
#define HI553_OTP_FUNCTION
#ifdef HI553_OTP_FUNCTION
//static kal_uint32 r_ratio;
//static kal_uint32 b_ratio;
#define RG_Ratio_Typical 0x149
#define BG_Ratio_Typical 0x11d
void HI553_Sensor_update_wb_gain(USHORT r_gain, USHORT b_gain, USHORT g_gain);
kal_uint16 HI553_Sensor_OTP_read(kal_uint16 otp_addr,kal_uint16 otp_addr_one,kal_uint16 otp_addr_two);
void HI553_Sensor_calc_wbdata(void);
static void HI553_OTP_cali(void);
#endif
// zhaozhensen@wind-mobi.com 20170210 end
...
/*zhenglihong@wind-mobi.com 20170422 change for bining */
  .custom1 = {	
		.pclk = 176000000,				//record different mode's pclk
		.linelength  = 2816,				//record different mode's linelength
		.framelength = 2049,			//record different mode's framelength
...
/*zhenglihong@wind-mobi.com 20170422 change for bining */
  ...
  .custom5 = {
    ...
    .custom1_delay_frame = 3,//zhenglihong@wind-mobi.com 20170422 change for binning 
	...
	.i2c_addr_table = {0x40, 0x6c,0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
...
//zhenglihong@wind-mobi.com 20170422 change for binning mode begin
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] =	 
{
 ...
 { 2592, 1944,	  0,  	0, 2592, 1944, 1920,  1080,   0,	0,  1920,  1080, 0, 0,  1920,1080}, // hight speed video
 { 2592, 1944,	  0,  	0, 2592, 1944, 1280,  720,   0,	0, 1280,  720, 	 0, 0, 1280,  720}, // slim
  { 2592, 1944,	  0,  	0, 2592, 1944, 1296,  972,   0,	0, 1296,  972, 	 0, 0, 1296,  972}, // custom1
};
//zhenglihong@wind-mobi.com 20170422 change for binning mode end
...
static void HI553_OTP_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
...
// zhaozhensen@wind-mobi.com 20160629 begin
#ifdef HI553_OTP_FUNCTION
...
static struct hi553_otp_struct hi553_otp_info;

void HI553_OTPSetting(void)
{
    LOG_INF("HI553OTPSetting begin:\n ");
    HI553_OTP_write_cmos_sensor(0x0A02, 0x01); //fast sleep On
    HI553_OTP_write_cmos_sensor(0x0a00, 0x00); //sleep On
    mDELAY(100);
    HI553_OTP_write_cmos_sensor(0x0F02, 0x00); //pll disable
    HI553_OTP_write_cmos_sensor(0x011A, 0x01); //CP TRI_H
    HI553_OTP_write_cmos_sensor(0x011B, 0x09); //IPGM TRIM_H
    HI553_OTP_write_cmos_sensor(0x0D04, 0x01); //Fsync Output enable
    HI553_OTP_write_cmos_sensor(0x0D00, 0x07); //Fsync Output Drivability
    //HI553_OTP_write_cmos_sensor(0x004C, 0x01); //TG MCU enable
    HI553_OTP_write_cmos_sensor(0x003F, 0x10); //OTP R/W
    HI553_OTP_write_cmos_sensor(0x0a00, 0x01); //sleep off
    LOG_INF("HI553OTPSetting exit :\n ");
}
...
kal_uint16 HI553_Sensor_OTP_read(kal_uint16 otp_addr,kal_uint16 otp_addr_one,kal_uint16 otp_addr_two)
{
    kal_uint16 i, data;
    i = otp_addr; 
    HI553_OTP_write_cmos_sensor(0x10a, (i >> 8) & 0xFF); //start address H        
    HI553_OTP_write_cmos_sensor(0x10b, i & 0xFF); //start address L
    HI553_OTP_write_cmos_sensor(0x102, 0x01); //single read
    //mDELAY(10);
...
void HI553_Sensor_OTP_info(void)
{
    ...
    sensor_id = 0,
    info_flag = 0;
    info_flag = HI553_Sensor_OTP_read(0x0501,0,0);
    LOG_INF("info_flag = 0x%x\n", info_flag);
    switch (info_flag)
    {
        case 0x01:
            ModuleHouseID = HI553_Sensor_OTP_read(0x0502,0,0);
            Year          = HI553_Sensor_OTP_read(0x0504,0,0);
            month         = HI553_Sensor_OTP_read(0x0505,0,0);
            day           = HI553_Sensor_OTP_read(0x0506,0,0);
            sensor_id     = HI553_Sensor_OTP_read(0x0507,0,0);
            break;
        case 0x13:
            ModuleHouseID = HI553_Sensor_OTP_read(0x0513,0,0);
            Year          = HI553_Sensor_OTP_read(0x0515,0,0);
            month         = HI553_Sensor_OTP_read(0x0516,0,0);
            day           = HI553_Sensor_OTP_read(0x0517,0,0);
            sensor_id     = HI553_Sensor_OTP_read(0x0518,0,0);
            break;
        case 0x37:
            ModuleHouseID = HI553_Sensor_OTP_read(0x0524,0,0);
            Year          = HI553_Sensor_OTP_read(0x0526,0,0);
            month         = HI553_Sensor_OTP_read(0x0527,0,0);
            day           = HI553_Sensor_OTP_read(0x0528,0,0);
            sensor_id     = HI553_Sensor_OTP_read(0x0529,0,0);
            break;
        default:	
            LOG_INF("HI553_Sensor: info_flag error value: %d \n ",info_flag);
        break;
    }
    LOG_INF("HI553_ModuleHouseID = %x \n", ModuleHouseID);
    LOG_INF("HI553_Year = %d \n", Year);
    LOG_INF("HI553_month = %d \n", month);
    LOG_INF("HI553_day = %d \n", day);	
    LOG_INF("HI553_sensor_id = %d \n", sensor_id);
...
void HI553_Sensor_calc_wbdata(void)
{
    ...
    switch (hi553_otp_info.wb_flag)
    {
        case 0x01:	//Group1 valid
            wb_unit_rg_h = HI553_Sensor_OTP_read(0x0536,0,0);
            wb_unit_rg_l = HI553_Sensor_OTP_read(0x0537,0,0);
            wb_unit_bg_h = HI553_Sensor_OTP_read(0x0538,0,0);
            wb_unit_bg_l = HI553_Sensor_OTP_read(0x0539,0,0);
            wb_unit_gg_h = HI553_Sensor_OTP_read(0x053A,0,0);
            wb_unit_gg_l = HI553_Sensor_OTP_read(0x053B,0,0);
            wb_golden_rg_h = HI553_Sensor_OTP_read(0x053C,0,0);
            wb_golden_rg_l = HI553_Sensor_OTP_read(0x053D,0,0);
            wb_golden_bg_h = HI553_Sensor_OTP_read(0x053E,0,0);
            wb_golden_bg_l = HI553_Sensor_OTP_read(0x053F,0,0);
            wb_golden_gg_h = HI553_Sensor_OTP_read(0x0540,0,0);
            wb_golden_gg_l = HI553_Sensor_OTP_read(0x0541,0,0);
            wb_unit_r_h = HI553_Sensor_OTP_read(0x0542,0,0);
            wb_unit_r_l = HI553_Sensor_OTP_read(0x0543,0,0);
            wb_unit_b_h = HI553_Sensor_OTP_read(0x0544,0,0);
            wb_unit_b_l = HI553_Sensor_OTP_read(0x0545,0,0);
            wb_unit_gr_h = HI553_Sensor_OTP_read(0x0546,0,0);
            wb_unit_gr_l = HI553_Sensor_OTP_read(0x0547,0,0);
            wb_unit_gb_h = HI553_Sensor_OTP_read(0x0548,0,0);
            wb_unit_gb_l = HI553_Sensor_OTP_read(0x0549,0,0);
            wb_golden_r_h = HI553_Sensor_OTP_read(0x054A,0,0);
            wb_golden_r_l = HI553_Sensor_OTP_read(0x054B,0,0);
            wb_golden_b_h = HI553_Sensor_OTP_read(0x054C,0,0);
            wb_golden_b_l = HI553_Sensor_OTP_read(0x054D,0,0);
            wb_golden_gr_h = HI553_Sensor_OTP_read(0x054E,0,0);
            wb_golden_gr_l = HI553_Sensor_OTP_read(0x054F,0,0);
            wb_golden_gb_h = HI553_Sensor_OTP_read(0x0550,0,0);
            wb_golden_gb_l = HI553_Sensor_OTP_read(0x0551,0,0);
            wbcheck = HI553_Sensor_OTP_read(0x0553,0,0);

			/* zhangdong add for otp info start */
		/*	hw_info_sub_otp.otp_valid = hi553_otp_info.wb_flag;
			hw_info_sub_otp.version = 0;
			hw_info_sub_otp.year = HI553_Sensor_OTP_read(0x0504,0,0);
			hw_info_sub_otp.month = HI553_Sensor_OTP_read(0x0505,0,0);
			hw_info_sub_otp.day = HI553_Sensor_OTP_read(0x0506,0,0);
			hw_info_sub_otp.vendor_id = HI553_Sensor_OTP_read(0x0502,0,0);
			hw_info_sub_otp.lens_id = HI553_Sensor_OTP_read(0x0508,0,0);
			hw_info_sub_otp.vcm_id = HI553_Sensor_OTP_read(0x0509,0,0);
	      */
			/* zhangdong add for otp info end */
            break;
        case 0x13:	//Group2 valid
            wb_unit_rg_h = HI553_Sensor_OTP_read(0x0554,0,0);
            wb_unit_rg_l = HI553_Sensor_OTP_read(0x0555,0,0);
            wb_unit_bg_h = HI553_Sensor_OTP_read(0x0556,0,0);
            wb_unit_bg_l = HI553_Sensor_OTP_read(0x0557,0,0);
            wb_unit_gg_h = HI553_Sensor_OTP_read(0x0558,0,0);
            wb_unit_gg_l = HI553_Sensor_OTP_read(0x0559,0,0);
            wb_golden_rg_h = HI553_Sensor_OTP_read(0x055A,0,0);
            wb_golden_rg_l = HI553_Sensor_OTP_read(0x055B,0,0);
            wb_golden_bg_h = HI553_Sensor_OTP_read(0x055C,0,0);
            wb_golden_bg_l = HI553_Sensor_OTP_read(0x055D,0,0);
            wb_golden_gg_h = HI553_Sensor_OTP_read(0x055E,0,0);
            wb_golden_gg_l = HI553_Sensor_OTP_read(0x055F,0,0);
            wb_unit_r_h = HI553_Sensor_OTP_read(0x0560,0,0);
            wb_unit_r_l = HI553_Sensor_OTP_read(0x0561,0,0);
            wb_unit_b_h = HI553_Sensor_OTP_read(0x0562,0,0);
            wb_unit_b_l = HI553_Sensor_OTP_read(0x0563,0,0);
            wb_unit_gr_h = HI553_Sensor_OTP_read(0x0564,0,0);
            wb_unit_gr_l = HI553_Sensor_OTP_read(0x0565,0,0);
            wb_unit_gb_h = HI553_Sensor_OTP_read(0x0566,0,0);
            wb_unit_gb_l = HI553_Sensor_OTP_read(0x0567,0,0);
            wb_golden_r_h = HI553_Sensor_OTP_read(0x0568,0,0);
            wb_golden_r_l = HI553_Sensor_OTP_read(0x0569,0,0);
            wb_golden_b_h = HI553_Sensor_OTP_read(0x056A,0,0);
            wb_golden_b_l = HI553_Sensor_OTP_read(0x056B,0,0);
            wb_golden_gr_h = HI553_Sensor_OTP_read(0x056C,0,0);
            wb_golden_gr_l = HI553_Sensor_OTP_read(0x056D,0,0);
            wb_golden_gb_h = HI553_Sensor_OTP_read(0x056E,0,0);
            wb_golden_gb_l = HI553_Sensor_OTP_read(0x056F,0,0);
            wbcheck = HI553_Sensor_OTP_read(0x0571,0,0);

			/* zhangdong add for otp info start */
			/*hw_info_sub_otp.otp_valid = hi553_otp_info.wb_flag;
			hw_info_sub_otp.version = 0;
			hw_info_sub_otp.year = HI553_Sensor_OTP_read(0x0515,0,0);
			hw_info_sub_otp.month = HI553_Sensor_OTP_read(0x0516,0,0);
			hw_info_sub_otp.day = HI553_Sensor_OTP_read(0x0517,0,0);
			hw_info_sub_otp.vendor_id = HI553_Sensor_OTP_read(0x0513,0,0);
			hw_info_sub_otp.lens_id = HI553_Sensor_OTP_read(0x0519,0,0);
			hw_info_sub_otp.vcm_id = HI553_Sensor_OTP_read(0x051A,0,0);
			*/
			/* zhangdong add for otp info end */
            break;
        case 0x37:	//Group3 valid
            wb_unit_rg_h = HI553_Sensor_OTP_read(0x0572,0,0);
            wb_unit_rg_l = HI553_Sensor_OTP_read(0x0573,0,0);
            wb_unit_bg_h = HI553_Sensor_OTP_read(0x0574,0,0);
            wb_unit_bg_l = HI553_Sensor_OTP_read(0x0575,0,0);
            wb_unit_gg_h = HI553_Sensor_OTP_read(0x0576,0,0);
            wb_unit_gg_l = HI553_Sensor_OTP_read(0x0577,0,0);
            wb_golden_rg_h = HI553_Sensor_OTP_read(0x0578,0,0);
            wb_golden_rg_l = HI553_Sensor_OTP_read(0x0579,0,0);
            wb_golden_bg_h = HI553_Sensor_OTP_read(0x057A,0,0);
            wb_golden_bg_l = HI553_Sensor_OTP_read(0x057B,0,0);
            wb_golden_gg_h = HI553_Sensor_OTP_read(0x057C,0,0);
            wb_golden_gg_l = HI553_Sensor_OTP_read(0x057D,0,0);
            wb_unit_r_h = HI553_Sensor_OTP_read(0x057E,0,0);
            wb_unit_r_l = HI553_Sensor_OTP_read(0x057F,0,0);
            wb_unit_b_h = HI553_Sensor_OTP_read(0x0580,0,0);
            wb_unit_b_l = HI553_Sensor_OTP_read(0x0581,0,0);
            wb_unit_gr_h = HI553_Sensor_OTP_read(0x0582,0,0);
            wb_unit_gr_l = HI553_Sensor_OTP_read(0x0583,0,0);
            wb_unit_gb_h = HI553_Sensor_OTP_read(0x0584,0,0);
            wb_unit_gb_l = HI553_Sensor_OTP_read(0x0585,0,0);
            wb_golden_r_h = HI553_Sensor_OTP_read(0x0586,0,0);
            wb_golden_r_l = HI553_Sensor_OTP_read(0x0587,0,0);
            wb_golden_b_h = HI553_Sensor_OTP_read(0x0588,0,0);
            wb_golden_b_l = HI553_Sensor_OTP_read(0x0589,0,0);
            wb_golden_gr_h = HI553_Sensor_OTP_read(0x058A,0,0);
            wb_golden_gr_l = HI553_Sensor_OTP_read(0x058B,0,0);
            wb_golden_gb_h = HI553_Sensor_OTP_read(0x058C,0,0);
            wb_golden_gb_l = HI553_Sensor_OTP_read(0x058D,0,0);
            wbcheck = HI553_Sensor_OTP_read(0x058F,0,0);

			/* zhangdong add for otp info start */
			/*
			hw_info_sub_otp.otp_valid = hi553_otp_info.wb_flag;
			hw_info_sub_otp.version = 0;
			hw_info_sub_otp.year = HI553_Sensor_OTP_read(0x0526,0,0);
			hw_info_sub_otp.month = HI553_Sensor_OTP_read(0x0527,0,0);
			hw_info_sub_otp.day = HI553_Sensor_OTP_read(0x0528,0,0);
			hw_info_sub_otp.vendor_id = HI553_Sensor_OTP_read(0x0524,0,0);
			hw_info_sub_otp.lens_id = HI553_Sensor_OTP_read(0x052A,0,0);
			hw_info_sub_otp.vcm_id = HI553_Sensor_OTP_read(0x052B,0,0);
			*/
			/* zhangdong add for otp info end */
            break;
        default:
            LOG_INF("HI553_Sensor: wb_flag error value: 0x%x\n ",hi553_otp_info.wb_flag);
        break;
    }

    LOG_INF("wb_unit_rg_h = 0x%x, wb_unit_rg_l = 0x%x, wb_unit_bg_h = 0x%x, wb_unit_bg_l = 0x%x, wb_golden_rg_h = 0x%x, wb_golden_rg_l = 0x%x, wb_golden_bg_h = 0x%x, wb_golden_bg_l = 0x%x,  wbcheck = 0x%x\n", 
    wb_unit_rg_h, wb_unit_rg_l, wb_unit_bg_h, wb_unit_bg_l, wb_golden_rg_h, wb_golden_rg_l, wb_golden_bg_h, wb_golden_bg_l, wbcheck);

    rg_golden_value = (((wb_golden_rg_h << 8) | wb_golden_rg_l ) & 0x03ff);
    bg_golden_value = (((wb_golden_bg_h << 8) | wb_golden_bg_l ) & 0x03ff);

    rg_value = (((wb_unit_rg_h << 8) | wb_unit_rg_l ) & 0x03ff);
    bg_value = (((wb_unit_bg_h << 8) | wb_unit_bg_l ) & 0x03ff);

    LOG_INF("Read from module: rg_golden_value = 0x%x, bg_golden_value = 0x%x\n", rg_golden_value, bg_golden_value);
    LOG_INF("Read from module: rg_value = 0x%x, bg_value = 0x%x\n",rg_value, bg_value);

    hi553_otp_info.r_gain = (0x100 * rg_golden_value) / rg_value;			//hi553_otp_info.r_gain = (0x100 * RG_Ratio_Typical) / rg_value;
    hi553_otp_info.b_gain = (0x100 * bg_golden_value) / bg_value;			//hi553_otp_info.b_gain = (0x100 * BG_Ratio_Typical) / bg_value;
    hi553_otp_info.g_gain = 0x100;
    if(hi553_otp_info.r_gain < hi553_otp_info.b_gain)
        {
            if(hi553_otp_info.r_gain < 0x100)
            {
                hi553_otp_info.b_gain = 0x100 * hi553_otp_info.b_gain / hi553_otp_info.r_gain;
                hi553_otp_info.g_gain = 0x100 * hi553_otp_info.g_gain / hi553_otp_info.r_gain;
                hi553_otp_info.r_gain = 0x100;
            }
    }
    else
     {
            if(hi553_otp_info.b_gain < 0x100)
            {
                hi553_otp_info.r_gain = 0x100 * hi553_otp_info.r_gain / hi553_otp_info.b_gain;
                hi553_otp_info.g_gain = 0x100 * hi553_otp_info.g_gain / hi553_otp_info.b_gain;
                hi553_otp_info.b_gain = 0x100;
            }
    }
    LOG_INF("HI553 After calcuate: g_gain = 0x%x, r_gain = 0x%x,b_gain = 0x%x\n", hi553_otp_info.g_gain,hi553_otp_info.r_gain,hi553_otp_info.b_gain);

}

void HI553_Sensor_update_wb_gain(USHORT rg, USHORT bg, USHORT gg)
{
    ...
    HI553_OTP_write_cmos_sensor(0x0a00, 0x00); //sleep On
    mdelay(100);
    HI553_OTP_write_cmos_sensor(0x003f, 0x00); //OTP mode off
    HI553_OTP_write_cmos_sensor(0x0a00, 0x01); //sleep Off

    r_gain = rg;
    b_gain = bg;
    g_gain = gg;
    LOG_INF("r_gain = 0x%x, b_gain = 0x%x\n",r_gain, b_gain);
    HI553_OTP_write_cmos_sensor(0x0126, g_gain >> 8); //g_gain
    HI553_OTP_write_cmos_sensor(0x0127, g_gain & 0xFFFF); //g_gain
    HI553_OTP_write_cmos_sensor(0x0128, g_gain >> 8); //g_gain
    HI553_OTP_write_cmos_sensor(0x0129, g_gain & 0xFFFF); //g_gain

    HI553_OTP_write_cmos_sensor(0x012a, r_gain >> 8); //r_gain
    HI553_OTP_write_cmos_sensor(0x012b, r_gain & 0xFFFF); //r_gain
    HI553_OTP_write_cmos_sensor(0x012c, b_gain >> 8); //b_gain
    HI553_OTP_write_cmos_sensor(0x012d, b_gain & 0xFFFF); //b_gain

    a05 = read_cmos_sensor_byte(0x0a05);
    LOG_INF("denis++a05 = %x\n",a05);
}

static void HI553_OTP_cali(void)
{
	LOG_INF("get in HI553_OTP_cali\n");
  if(hi553_otp_info.wb_flag == 0x01 || hi553_otp_info.wb_flag == 0x13 || hi553_otp_info.wb_flag == 0x37) {
        HI553_OTPSetting();
        HI553_Sensor_calc_wbdata();
        //HI553_Sensor_OTP_info();
        HI553_Sensor_update_wb_gain( hi553_otp_info.r_gain, hi553_otp_info.b_gain, hi553_otp_info.g_gain);
   } else {
        HI553_OTPSetting();
        hi553_otp_info.wb_flag = HI553_Sensor_OTP_read(0x0535,0,0);
   	...
   	LOG_INF("get out HI553_OTP_cali\n");
}

#endif
// zhaozhensen@wind-mobi.com 20160629 end
/*************************************************************************
* FUNCTION
*	night_mode
*
...
//BLC offset	  : 64code
////////////////////////////////////////////////
LOG_INF("capture_setting currefps == 300");
write_cmos_sensor(0x0a00, 0x0000); //stream on         
write_cmos_sensor(0x0b14, 0x404c);
write_cmos_sensor(0x0b16, 0x6e0b);                     
write_cmos_sensor(0x0b18, 0xf20b);                     
...
write_cmos_sensor(0x0a00, 0x0100); //stream on
	...
	//else if (currefps == 240) {}
		...
		LOG_INF("capture_setting currefps == 150");
		write_cmos_sensor(0x0a00, 0x0000); //stream on
		write_cmos_sensor(0x0b14, 0x404c);
		write_cmos_sensor(0x0b16, 0x6e0b);
		write_cmos_sensor(0x0b18, 0xf20b);
...
////////////////////////////////////////////////
		...
		write_cmos_sensor(0x004a, 0x0100);
		write_cmos_sensor(0x000c, 0x0022);
		write_cmos_sensor(0x0008, 0x0a04);//2564
		write_cmos_sensor(0x005a, 0x0202);//514
		write_cmos_sensor(0x0012, 0x015e);
		write_cmos_sensor(0x0018, 0x08e1);
		write_cmos_sensor(0x0024, 0x01e8);
		write_cmos_sensor(0x002a, 0x01ed);
		write_cmos_sensor(0x0026, 0x01f0);
		write_cmos_sensor(0x002c, 0x0627);
		write_cmos_sensor(0x002e, 0x1111);
		write_cmos_sensor(0x0030, 0x1111);
		write_cmos_sensor(0x0032, 0x1111);
		write_cmos_sensor(0x001a, 0x1111);
		write_cmos_sensor(0x001c, 0x1111);
		write_cmos_sensor(0x001e, 0x1111);
		write_cmos_sensor(0x0006, 0x0478); //frame length lines 1144
		write_cmos_sensor(0x0a22, 0x0000);
		write_cmos_sensor(0x0a12, 0x0780); //x output size 1920
		write_cmos_sensor(0x0a14, 0x0438); //y output size 1080
		write_cmos_sensor(0x003e, 0x1000);
		write_cmos_sensor(0x0004, 0x0472); //coarse int. time
		write_cmos_sensor(0x0a04, 0x014a); //isp_en
		write_cmos_sensor(0x0a1A, 0x0800);
		write_cmos_sensor(0x090c, 0x0462);
		write_cmos_sensor(0x090e, 0x0133);
	//===============================================
	//			   mipi 2 lane 220Mbps
	//===============================================
		write_cmos_sensor(0x0902, 0x431a);
		...
		write_cmos_sensor(0x0916, 0x071f);
		write_cmos_sensor(0x091c, 0x0e09);
		write_cmos_sensor(0x0918, 0x0308);
		write_cmos_sensor(0x091a, 0x0c0c);
		write_cmos_sensor(0x091e, 0x0a00);
		write_cmos_sensor(0x0a00, 0x0100); //stream on
#else
		...
		write_cmos_sensor(0x004a, 0x0100);
		write_cmos_sensor(0x000c, 0x0022);
		write_cmos_sensor(0x0008, 0x0b00);//2816
		write_cmos_sensor(0x005a, 0x0208);//520
		...
		write_cmos_sensor(0x0a12, 0x0280); //x output size 640
		write_cmos_sensor(0x0a14, 0x01e0); //y output size 480
		write_cmos_sensor(0x003e, 0x0000);
...
static void slim_video_setting(void)
{
	LOG_INF("E\n slim_video_setting");
		...
		write_cmos_sensor(0x000c, 0x0022);
		write_cmos_sensor(0x0008, 0x0b00);//2816
		write_cmos_sensor(0x005a, 0x0823);//2083
		write_cmos_sensor(0x0012, 0x001E);
		write_cmos_sensor(0x0018, 0x0a21);
		...
		write_cmos_sensor(0x0a22, 0x0000);
		write_cmos_sensor(0x0a12, 0x0500); //x output size 1280
		write_cmos_sensor(0x0a14, 0x02d0); //y output size 720
		write_cmos_sensor(0x003e, 0x0000);
