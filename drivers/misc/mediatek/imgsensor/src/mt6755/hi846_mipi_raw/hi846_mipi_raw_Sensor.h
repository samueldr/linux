// zhaozhensen@wind-mobi.com 20161227 begin
/*****************************************************************************
 *
 * Filename:
 * ---------
...
typedef enum{
	...
	IMGSENSOR_MODE_CUSTOM1,//zhenglihong@wind-mobi.com 20170422 
} IMGSENSOR_MODE;
...
typedef struct imgsensor_info_struct {
    ...
    imgsensor_mode_struct custom1;	//zhenglihong@wind-mobi.com 20170422 change for binning mode
    ...
    kal_uint8  custom1_delay_frame;	//zhenglihong@wind-mobi.com 20170422 change for binning mode
...
#endif 
// zhaozhensen@wind-mobi.com 20161227 end