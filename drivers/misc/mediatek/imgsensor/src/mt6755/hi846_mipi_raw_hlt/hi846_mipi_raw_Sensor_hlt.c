...
#include "hi846_mipi_raw_Sensor_hlt.h"
    ...
    static void HI846_Sensor_calc_wbdata(void)
    {
        ...
        switch (wb_flag)
        {
    		...
    		case 0x02:  //Group2 valid
                ...
                {
                    addr = 0x0c7e + i;
                    printk("zzs HI846_Sensor: group 2 addr = 0x%x   0x%x\n ",i+0x0c7e,HI846_Sensor_OTP_read(addr));
                }	
                break;
    		case 0x03:  //Group3 valid
                ...
                {
                	addr = 0x0c9c + i;
                	printk("zzs HI846_Sensor: group 3 addr = 0x%x   0x%x\n ",i+0x0c9c,HI846_Sensor_OTP_read(addr));
                }	
                break;
    		default:
    	...
    	rg_golden_value = 0x00E3;
    	bg_golden_value = 0x011C;
...
UINT32 HI846_MIPI_RAW_SensorInit_Hlt(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
