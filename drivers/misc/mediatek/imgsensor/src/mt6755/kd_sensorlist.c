...
/* The following is to avoid build error of project: mt6755_fpga related //Jessy @2014/06/04 */
    ...
    #define SUPPORT_I2C_BUS_NUM2      1 /***zhaozhensen@wind-mobi.com 20161012 ***/
#endif
...
//Main2 support
    ...
    #define SUPPORT_I2C_BUS_NUM3        1 /**dingyisheng@wind-mobi.com 20170811 ***/
#else
...
//add by lihaiyan@wind-mobi.com 20170426 begin
#if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
extern char g_imgsensor_name[3][32];
#endif
//add by lihaiyan@wind-mobi.com 20170426 end
...
// zhaozhensen@wind-mobi.com 20161121 for hi843b_otp probelem begin
...
// zhaozhensen@wind-mobi.com 20161121 for hi843b_otp problem end
...
inline static int adopt_CAMERA_HW_CheckIsAlive(void)
{
    ...
    /* power on sensor */
  #if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
     PowerState = kdModulePowerOn((CAMERA_DUAL_CAMERA_SENSOR_ENUM *)g_invokeSocketIdx, g_invokeSensorNameStr, true, CAMERA_HW_DRVNAME1);
  #else
...
if (!PowerState) {
    ...
    for (i = KDIMGSENSOR_INVOKE_DRIVER_0; i < KDIMGSENSOR_MAX_INVOKE_DRIVERS; i++) {
        ...
        if (sensorID == 0) {    /* not implement this feature ID */
			...
			//add by lihaiyan@wind-mobi.com 20170426 begin
                        #if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)||(defined CONFIG_WIND_DEF_PRO_E260L)||(defined CONFIG_WIND_DEF_PRO_E262L)
				memcpy((char *)g_imgsensor_name[(g_invokeSocketIdx[i]>>1)], (char *)g_invokeSensorNameStr[i], sizeof(g_invokeSensorNameStr[i]));
			#endif
			//add by lihaiyan@wind-mobi.com 20170426 end
