...
//yeshaobo@wind-mobi.com 20170614 begin
static unsigned int set_shutter_flag = 0;
//yeshaobo@wind-mobi.com 20170614 end
static imgsensor_info_struct imgsensor_info = {
	...
	.slim_video = {
		...
		.grabwindow_height = 768,
		.mipi_data_lp2hs_settle_dc = 90,
		//dingyisheng@wind-mobi.com 20170523 begin
		.max_framerate = 300,
		//dingyisheng@wind-mobi.com 20170523 end
    },
...
//zhenglihong@wind-mobi.com 20170422 end
    ...
    .custom1_delay_frame = 3,//zhenglihong@wind-mobi.com 20170422 begin
	...
	//yeshaobo@wind-mobi.com 20170328 begin
    .i2c_addr_table = { 0x20,0x40, 0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
	//yeshaobo@wind-mobi.com 20170328 end
    .i2c_speed = 400,
};
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =
{
	...
	{ 4256, 3168, 0,   8, 4256, 3152, 2128, 1576,  8,	4,	 2112, 1568, 0,   0,   2112, 1568}, //custom1 zhenglihong@wind-mobi.com 20170422 
};

/*PD information update*/
//yeshaobo@wind-mobi.com begin
...
static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
    ...
    //kdSetI2CSpeed(100); // Add this func to set i2c speed by each sensor
...
//yeshaobo@wind-mobi.com 20170626 begin
static void set_shutter(unsigned long long shutter)
{
	unsigned long flags;
  	kal_uint16 realtime_fps = 0;
	//kal_uint16 read_data[22];
	//int i;
	...
	if(shutter >= 0xFFF0 )   // need to modify line_length & PCLK
	{
		...
		write_cmos_sensor(0x5203, 0x04);
		write_cmos_sensor(0x5204, 0x00);
		write_cmos_sensor(0x5205, 0x40);
		write_cmos_sensor(0x520d, 0xf5);
		write_cmos_sensor(0x5207, 0x84);
		write_cmos_sensor(0x5208, 0x48);
		
		LOG_INF("ENTER long shutter\n");
		switch(shutter)
		{
			case 96413: //1s
				write_cmos_sensor(0x3c9a, 0x00);
				write_cmos_sensor(0x3c9b, 0x06);
				write_cmos_sensor(0x3c9c, 0x6f);
				write_cmos_sensor(0x3c9d, 0xd2);
				LOG_INF("Time :1s\n");
				break;
			case 192826: //2s
				write_cmos_sensor(0x3c9a, 0x00);
				write_cmos_sensor(0x3c9b, 0x0c);
				write_cmos_sensor(0x3c9c, 0xdf);
				write_cmos_sensor(0x3c9d, 0xa4); 
				LOG_INF("Time :2s\n");
				break;
			case 385653: //4s
				write_cmos_sensor(0x3c9a, 0x00);
				write_cmos_sensor(0x3c9b, 0x19);
				write_cmos_sensor(0x3c9c, 0xbf);
				write_cmos_sensor(0x3c9d, 0x48);
				LOG_INF("Time :4s\n");
				break;
			case 771307: //8s
				write_cmos_sensor(0x3c9a, 0x00);
				write_cmos_sensor(0x3c9b, 0x33);
				write_cmos_sensor(0x3c9c, 0x7e);
				write_cmos_sensor(0x3c9d, 0x90);
				LOG_INF("Time :8s\n");
				break;
			case 964134: //10s
				write_cmos_sensor(0x3c9a, 0x00);
				write_cmos_sensor(0x3c9b, 0x40);
				write_cmos_sensor(0x3c9c, 0x5e);
				write_cmos_sensor(0x3c9d, 0x34);
				LOG_INF("Time :10s\n");
				break;
   ...
   else
   {
	...
	write_cmos_sensor(0x5205, 0x41);
	write_cmos_sensor(0x520d, 0x0f);
	write_cmos_sensor(0x5207, 0x84);
	write_cmos_sensor(0x5208, 0x40);
//	write_cmos_sensor(0x3c9a, 0x00);
//	write_cmos_sensor(0x3c9b, 0x00);
//	write_cmos_sensor(0x3c9c, 0x00);
//	write_cmos_sensor(0x3c9d, 0x10);
    ...
    LOG_INF("shutter =%lld, framelength =%d, realtime_fps =%d\n", shutter,imgsensor.frame_length, realtime_fps);
	}
		set_shutter_flag  = 0;
}
//yeshaobo@wind-mobi.com 20170626 end
...
//dingyisheng@wind-mobi.com 20170523 begin
	//write_cmos_sensor(0x4010, 0xf0);//blc trigger by will
//dingyisheng@wind-mobi.com 20170523 end
	write_cmos_sensor(0x0100,0x00);
}
...
if(currefps == 150){
	...
	//dingyisheng@wind-mobi.com 20170523 begin
	//write_cmos_sensor(0x4010, 0xb0);//blc trigger by will
	//dingyisheng@wind-mobi.com 20170523 end
}else{
	//30fps
...
{
	//yeshaobo@wind-mobi.com 20170328 begin
    return (((read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c))>>8);
	//yeshaobo@wind-mobi.com 20170328 end
}
...
//zhenglihong@wind-mobi.com 20170422 change for binning mdoe
