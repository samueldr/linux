...
#define PDAF_TEST     //dingyisheng@wind-mobi.com 20171222 PDAF open
#ifdef PDAF_TEST
...
//wangkangmin@wind-mobi.com modify for video pd
	.pre = {
...
//wangkangmin@wind-mobi.com modify for video pd
  ...
  .cap2 = {
	...
	//dingyisheng@wind-mobi.com 20171024 begin
    .custom1 = {
		.pclk = 288000000,											//record different mode's pclk
		.linelength = 2512,		/*OV16880 Note: linelength/4,it means line length per lane*/
		.framelength = 3824,			//record different mode's framelength
	...
	//dingyisheng@wind-mobi.com 20171024 end	
	.margin = 8,
	.min_shutter = 4,
...
{{ 4704, 3536,	   0,     8, 4704, 3520, 2352, 1760,  8, 2, 2336, 1752,	  0,	0, 2336, 1752}, // Preview //wangkangmin@wind-mobi.com modify for video pd
 { 4704, 3536,	   0,     8, 4704, 3520, 4704, 3520, 16, 8, 4672, 3504,	  0,	0, 4672, 3504}, // capture
 { 4704, 3536,	   0,     8, 4704, 3520, 4704, 3520, 8, 4, 4672, 3504,	  0,	0, 4672, 3504}, // video //wangkangmin@wind-mobi.com modify for video pd
 ...
 { 4704, 3536,	   0,     8, 4704, 3520, 2352, 1760,  8, 2, 2336, 1752,	  0,	0, 2336, 1752}, // custom1
//dingyisheng@wind-mobi.com 20171024 begin
};
...
static void write_shutter(kal_uint32 shutter)
{
	...
	kal_uint16 Multi=0;
	kal_uint32 Base_FrameLength2=0x1A8EA;
	set_shutter_flag  = 1;
	LOG_INF("write_shutter shutter=%d\n",shutter);
	if(shutter >= 0xFFFF )   // need to modify line_length & PCLK
	{
	   Multi=shutter/Base_FrameLength2;
	   write_cmos_sensor_8(0x0100, 0x00);
	   write_cmos_sensor_8(0x0302, 0x3c);
	   write_cmos_sensor_8(0x380e, 0x7f);
	   write_cmos_sensor_8(0x380f, 0xf0);
	   write_cmos_sensor_8(0x3500, 0x00);
	   write_cmos_sensor_8(0x3501, 0x7f);
	   write_cmos_sensor_8(0x3502, 0xe8);
	   //write_cmos_sensor_8(0x350b, 0x10);
	   
	 /*  write_cmos_sensor_8(0x5000, 0x99);
	   write_cmos_sensor_8(0x5001, 0x4a);
	   write_cmos_sensor_8(0x560a, 0x03);
	   write_cmos_sensor_8(0x560b, 0x02);
	   write_cmos_sensor_8(0x560d, 0xff);
	   write_cmos_sensor_8(0x560f, 0xff);*/
	   LOG_INF("Multi=%d\n",Multi);
	switch(Multi)
		{
			case 1: //1s
				...
				write_cmos_sensor_8(0x380c, 0x44);
				write_cmos_sensor_8(0x380d, 0xb2);
			...
			case 2: //2s
				write_cmos_sensor_8(0x0303, 0x00);
				write_cmos_sensor_8(0x030f, 0x03);
				write_cmos_sensor_8(0x380c, 0x89);
				write_cmos_sensor_8(0x380d, 0x65); 
				write_cmos_sensor_8(0x4837, 0x0b);
				LOG_INF("Time :2s\n");
				break;
			case 4: //4s
			...
			case 8: //8s
				write_cmos_sensor_8(0x0303, 0x00);
				write_cmos_sensor_8(0x030f, 0x0b);
				write_cmos_sensor_8(0x380c, 0xb7);
				write_cmos_sensor_8(0x380d, 0x31);
				write_cmos_sensor_8(0x4837, 0x0b);
				LOG_INF("Time :8s\n");
				break;
			case 10: //10s
				write_cmos_sensor_8(0x0303, 0x00);
				write_cmos_sensor_8(0x030f, 0x0e);
				write_cmos_sensor_8(0x380c, 0xb7);
				write_cmos_sensor_8(0x380d, 0x31);
				write_cmos_sensor_8(0x4837, 0x0b);
				LOG_INF("Time :10s\n");
	...
	else
	{
	  ...
	  /* write_cmos_sensor_8(0x5000, 0x9f);
	   ...
	   write_cmos_sensor_8(0x560a, 0x06);
	   write_cmos_sensor_8(0x560b, 0x03);
	   write_cmos_sensor_8(0x560d, 0xfe);
	...
	//LOG_INF("read_cmos_sensor_8(0x0302)=0x%x\n",read_cmos_sensor_8(0x0302));
	//LOG_INF("read_cmos_sensor_8(0x030F)=0x%x\n",read_cmos_sensor_8(0x030F));
	//LOG_INF("read_cmos_sensor_8(0x380C)=0x%x\n",read_cmos_sensor_8(0x380C));
	//LOG_INF("read_cmos_sensor_8(0x380D)=0x%x\n",read_cmos_sensor_8(0x380D));
	//LOG_INF("read_cmos_sensor_8(0x380E)=0x%x\n",read_cmos_sensor_8(0x380E));
	//LOG_INF("read_cmos_sensor_8(0x380F)=0x%x\n",read_cmos_sensor_8(0x380F));
	//LOG_INF("read_cmos_sensor_8(0x3500)=0x%x\n",read_cmos_sensor_8(0x3500));
	//LOG_INF("read_cmos_sensor_8(0x3501)=0x%x\n",read_cmos_sensor_8(0x3501));
	//LOG_INF("read_cmos_sensor_8(0x3502)=0x%x\n",read_cmos_sensor_8(0x3502));
	//LOG_INF("read_cmos_sensor_8(0x350B)=0x%x\n",read_cmos_sensor_8(0x350B));
...
static void sensor_init(void)
{
	...
	//wrtie_eeprom(0x0100, data, 0x600);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {	
			*sensor_id = (read_cmos_sensor_8(0x300A) << 16) | (read_cmos_sensor_8(0x300B)<<8) | read_cmos_sensor_8(0x300C);
			LOGE("Read sensor id fail, write id:0x%x ,sensor Id:0x%x\n", imgsensor.i2c_write_id, *sensor_id);//lx_revised
			if (*sensor_id == imgsensor_info.sensor_id) {
				LOGE("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
				return ERROR_NONE;
			}
			LOGE("Read sensor id fail, write id:0x%x ,sensor Id:0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->PDAF_Support = 1; //dingyisheng@wind-mobi.com 20171222 PDAF open
...
//wangkangmin@wind-mobi.com modify for video pd
		case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
			...
			{
				case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; //dingyisheng@wind-mobi.com 20171222 PDAF
				break;
				case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; // video & capture use same setting //wangkangmin@wind-mobi.com modify for video pd
				break;
				case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
				...
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 0;
				break;
				case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; //wangkangmin@wind-mobi.com modify for video pd
				break;
				default:
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 0;
				break;
...
UINT32 OV16880_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
