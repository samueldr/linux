...
/*===FEATURE SWITH===*/
#define FPTPDAFSUPPORT   //for pdaf switch // zhaozhensen@wind-mobi.com 20170214
...
extern bool S5K3L8_ofg_read_eeprom_pdaf( kal_uint16 addr, BYTE* data, kal_uint32 size);
extern kal_uint8 S5K3L8_ofg_read_eeprom_module_id(void);
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K3L8_SENSOR_ID_OFG,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
    ...
    kal_uint32  id = (read_cmos_sensor_byte(0x0000) << 8) | read_cmos_sensor_byte(0x0001);
     ...
     module_id =  S5K3L8_ofg_read_eeprom_module_id();
    if (0x07 == module_id)
	id = id + 1;
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			S5K3L8_ofg_read_eeprom_pdaf((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;	
        /******************** PDAF END   <<< *********/
        default:
            break;
...
UINT32 S5K3L8_MIPI_RAW_SensorInit_Ofg(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
