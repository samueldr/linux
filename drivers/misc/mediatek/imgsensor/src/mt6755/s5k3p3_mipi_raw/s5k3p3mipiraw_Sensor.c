...
#ifdef PDAF_Support
extern bool read_3P3_eeprom_sub( kal_uint16 addr, BYTE* data, kal_uint32 size);
#endif
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			#ifdef PDAF_Support
			read_3P3_eeprom_sub((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			#endif
			break;
