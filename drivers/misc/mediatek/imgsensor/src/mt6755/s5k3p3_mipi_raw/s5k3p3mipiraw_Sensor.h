 ...
 *
 ****************************************************************************/
#ifndef _S5K3P3MIPI_SENSOR_H
#define _S5K3P3MIPI_SENSOR_H
...
typedef struct imgsensor_info_struct {
	...
	//dingyisheng@wind-mobi.com begin
	imgsensor_mode_struct custom1;	//custom for lowlight
	//dingyisheng@wind-mobi.com end
	...
	//dingyisheng@wind-mobi.com begin
	kal_uint8  custom1_delay_frame;	//custom for lowlight
	//dingyisheng@wind-mobi.com end
