...
#define FRAME_HEIGHT 										(2160)//liukangping
//modify by qiangang end
#define LCM_ID_ili7807d01                                                              (0x7807)
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.cont_clock=1;
		...
		params->dsi.vertical_sync_active				= 2; //modified by hebiao at 20161221 for Tp noise
		params->dsi.vertical_backporch				    = 8; //modified by hebiao at 20161221 for Tp noise
		params->dsi.vertical_frontporch				    = 14; //modified by hebiao at 20161221 for Tp noise
		params->dsi.vertical_active_line				= FRAME_HEIGHT;     
		params->dsi.horizontal_sync_active				= 20;
		params->dsi.horizontal_backporch				= 40; //modified by hebiao at 20161221 for Tp noise
		params->dsi.horizontal_frontporch				= 20; //modified by hebiao at 20161221 for Tp noise
...
static unsigned int lcm_compare_id(void)
{
   ...
   // id1 = buffer[0];
    ...
    id2 = buffer[0];
	printk(" LK ili9881c huashi cpt debug id=%x id1(0xDA)=%x id2(0xDB)=%x \n",id, id1, id2);	
...
LCM_DRIVER ili7807d01_fhd_dsi_vdo_tianma_lcm_drv =
{
	.name           	= "ili7807d01_fhd_dsi_vdo_tianma",
