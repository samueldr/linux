...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.cont_clock=1;
		...
		params->dsi.vertical_sync_active				= 6; //modified by hebiao at 20161221 for Tp noise
		params->dsi.vertical_backporch				    = 15; //modified by hebiao at 20161221 for Tp noise
		params->dsi.vertical_frontporch				    = 19; //modified by hebiao at 20161221 for Tp noise
		params->dsi.vertical_active_line				= FRAME_HEIGHT;     
		params->dsi.horizontal_sync_active				= 40;
		params->dsi.horizontal_backporch				= 120; //modified by hebiao at 20161221 for Tp noise
		params->dsi.horizontal_frontporch				= 80; //modified by hebiao at 20161221 for Tp noise
...
static void lcm_suspend(void) 
{
	...
	printk("[wjwind] ili9881c_hd720_dsi_vdo_boe_ykl %s \n",__func__);
	//MDELAY(10);
}
...
static unsigned int lcm_compare_id(void)
{
	...
	printf(" LK ili9881c_hd720_dsi_vdo_boe_ykl debug: %s id=%x id1=%x id2=%x \n",__func__,id, id1, id2);
#else
	printk(" kernel ili9881c_hd720_dsi_vdo_boe_ykl hlt horse debug: %s id=%x  \n",__func__,id);
#endif	
...
LCM_DRIVER ili9881c_hd720_dsi_vdo_boe_ykl_lcm_drv =
{
	.name           	= "ili9881c_hd720_dsi_vdo_boe_ykl",
