//zhangkaiyuan@wind-mobi.com 20170927 begin
...
#define FRAME_HEIGHT                                         (1440)    //zhangbeibei@wind-mobi.com 20170822
#define LCM_ID_ILI9881_HSD                                                              (0x1D)
...
/**************************************************/
    ...
    {0x6F,1,{0x35}},                // reg vcl + pumping ratio VGH=4x VGL=-2.5x               //POWER SAVING
...
//zhangbeibei@wind-mobi.com 20170822 end
#if 0
...
static unsigned int lcm_compare_id(void)
{
  ...
  //  array[2]=0x00000000;
    ...
    read_reg_v2(0xDA, buffer, 1); //0x1d
    id = buffer[0];
	printk(" LK ili9881c huashi hsd debug id(0xDA)=%x \n",id);
    if(LCM_ID_ILI9881_HSD == id)
    {
		   return 1;
    }
    else
...
//zhounengwen@wind-mobi.com 20160331 begin
...
//zhounengwen@wind-mobi.com 20160331 end
...
#endif
LCM_DRIVER ili9881c_hd720_dsi_vdo_hs_lcm_drv =
{
    .name               = "ili9881c_hd720_dsi_vdo_hs",
    ...
    .ata_check        = lcm_ata_check,  //zhounengwen@wind-mobi.com 20160412 modify
#ifdef WIND_LCD_POWER_SUPPLY_SUPPORT
...
//zhangkaiyuan@wind-mobi.com 20170927 end
