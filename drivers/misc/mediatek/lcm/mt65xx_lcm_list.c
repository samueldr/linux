...
#if defined(HX8399_FHD_DSI_VDO_HLT)
        &hx8399_fhd_dsi_vdo_hlt_lcm_drv,
#endif

#if defined(ILI7807D01_FHD_DSI_VDO_TIANMA)
        &ili7807d01_fhd_dsi_vdo_tianma_lcm_drv,
#endif
//wangjun@wind-mobi.com 20170920 end

//wangbing@wind-mobi.com 20170803 begin
#if defined(ST7703_HD720_DSI_VDO_YKL)
        &st7703_hd720_dsi_vdo_ykl_lcm_drv,
#endif
//wangbing@wind-mobi.com 20170803 end

//liukangping@wind-mobi.com 20170517 begin
#if defined(HX8394F_HD720_DSI_VDO_YKL)
	&hx8394f_hd720_dsi_vdo_ykl_lcm_drv,
#endif

//liukangping@wind-mobi.com 20170517 begin

//wangjun@wind-mobi.com 20170517 begin
#if defined(HIMAX83102_HD720_DSI_VDO_YJ_INSELL)
	&himax83102_hd720_dsi_vdo_yj_insell_lcm_drv,
#endif
//wangjun@wind-mobi.com 20170517 end    
    
//wangjun@wind-mobi.com 20170517 begin
#if defined(ILI9881C_HD720_DSI_VDO_BOE_YKL)
	&ili9881c_hd720_dsi_vdo_boe_ykl_lcm_drv,
#endif
//wangjun@wind-mobi.com 20170517 end
#if defined(FT8006_HD720_DSI_VDO_HLT_INSELL)
	&ft8006_hd720_dsi_vdo_hlt_insell_lcm_drv,
#endif	

//hebiao@wind-mobi.com 20161108 begin
#if defined(OTM1289A_HSD_DSI_VDO_TXD)
	&otm1289a_hsd_dsi_vdo_lcm_drv_txd,
#endif
#if defined(OTM1289A_HSD_DSI_VDO_GX)
	&otm1289a_hsd_dsi_vdo_lcm_drv_gx,
#endif
//hebiao@wind-mobi.com 2016111108 end
//ranyanhao@wind-mobi.com 20160825 begin
#if defined(ILI9881_HD720_DSI_VDO_HLT)
	&ili9881_hd720_dsi_vdo_hlt_lcm_drv,
#endif
//ranyanhao@wind-mobi.com 20160825 end

//lihaiyan@wind-mobi.com 20170114 begin
#if defined(ILI9881C_HD720_DSI_VDO_YASSY)
	&ili9881c_hd720_dsi_vdo_yassy_lcm_drv,
#endif
//lihaiyan@wind-mobi.com 20170114 end

//qiangang@wind-mobi.com 20170207 begin
#if defined(S6D7AA6X01_HD720_DSI_VDO_HS)
	&s6d7aa6x01_hd720_dsi_vdo_hs_lcm_drv,
#endif	
//qiangang@wind-mobi.com 20170207 end

//zhangkaiyuan@wind-mobi.com 20170919 begin	
#if defined(ILI9881C_HD720_DSI_VDO_HS)
    &ili9881c_hd720_dsi_vdo_hs_lcm_drv,
#endif
#if defined(ST7703_HD720_DSI_VDO_TXD)
    &st7703_hd720_dsi_vdo_txd_lcm_drv,
#endif
