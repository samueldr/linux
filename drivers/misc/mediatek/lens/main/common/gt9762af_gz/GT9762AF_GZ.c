...
/* ////////////////////////////////////////////////////////////// */
long GT9762AF_GZ_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int GT9762AF_GZ_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    ...
    if (i4RetValue < 0) 
     {
         LOG_INF("[GT9762AF_GZ] I2C send failed!! \n");
         return -1;
		 }
	LOG_INF("End\n");
