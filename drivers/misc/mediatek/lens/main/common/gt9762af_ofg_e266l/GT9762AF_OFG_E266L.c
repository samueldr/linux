...
#define AF_DRVNAME "GT9762AF_OFG_E266L"
...
static void initdrv(void)
{
	 ...
	 char puSendCmd1[2]={(char)(0xEC),(char)(0xA3)};
     char puSendCmd2[2]={(char)(0xA1),(char)(0x0D)};
     char puSendCmd3[2]={(char)(0xF2),(char)(0x18)};
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("ciel_test_open_count = %d\n",*g_pAF_Opened);
	if (*g_pAF_Opened == 1) {
...
/* ////////////////////////////////////////////////////////////// */
long GT9762AF_OFG_E266L_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int GT9762AF_OFG_E266L_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	char puSendCmd5[2]={(char)(0x80),(char)(0x00)};//power down mode
	int i4RetValue;
	LOG_INF("Start\n");
	if (*g_pAF_Opened == 2) {
		g_sr = 5;
    ...
    if (i4RetValue < 0) 
     {
         LOG_INF("[GT9762AF_OFG_E266L] I2C send failed!! \n");
         return -1;
		 }
	LOG_INF("End\n");
...
void GT9762AF_OFG_E266L_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
