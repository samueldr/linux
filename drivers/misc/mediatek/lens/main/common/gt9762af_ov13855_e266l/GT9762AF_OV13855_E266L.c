...
#define AF_DRVNAME "GT9762AF_OV13855_E266L"
...
long GT9762AF_OV13855_E266L_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
...
//yeshaobo@wind-mobi.com 20170331 begin
int GT9762AF_OV13855_E266L_Release(struct inode *a_pstInode, struct file *a_pstFile)
//yeshaobo@wind-mobi.com 20170331 end
{
    ...
    if (i4RetValue < 0) 
     {
         LOG_INF("[GT9762AF_OV13855_E266L] I2C send failed!! \n");
         return -1;
		 }
	LOG_INF("End\n");
