...
#define AF_DRVNAME "GT9762AF_S5K3M2"
...
/* ////////////////////////////////////////////////////////////// */
long GT9762AF_S5K3M2_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int GT9762AF_S5K3M2_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    ...
    if (i4RetValue < 0) 
     {
         LOG_INF("[GT9762AF_S5K3M2] I2C send failed!! \n");
         return -1;
		 }
	LOG_INF("End\n");
...
void GT9762AF_S5K3M2_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
