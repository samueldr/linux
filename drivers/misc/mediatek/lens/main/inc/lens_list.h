...
//zhenglihong@wind-mobi.com 20161012 begin
#ifdef CONFIG_MTK_LENS_GT9762AF_SUPPORT
#define GT9762AF_SetI2Cclient GT9762AF_SetI2Cclient_Main
#define GT9762AF_Ioctl GT9762AF_Ioctl_Main
#define GT9762AF_Release GT9762AF_Release_Main
extern void GT9762AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//zhenglihong@wind-mobi.com 20161012 end


//zhenglihong@wind-mobi.com 20170208 begin

#ifdef CONFIG_MTK_LENS_GT9762AF_GZ_E266L_SUPPORT
#define GT9762AF_GZ_E266L_SetI2Cclient GT9762AF_GZ_E266L_SetI2Cclient_Main
#define GT9762AF_GZ_E266L_Ioctl GT9762AF_GZ_E266L_Ioctl_Main
#define GT9762AF_GZ_E266L_Release GT9762AF_GZ_E266L_Release_Main
extern void GT9762AF_GZ_E266L_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_GZ_E266L_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_GZ_E266L_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
#ifdef CONFIG_MTK_LENS_GT9762AF_OFG_E266L_SUPPORT
#define GT9762AF_OFG_E266L_SetI2Cclient GT9762AF_OFG_E266L_SetI2Cclient_Main
#define GT9762AF_OFG_E266L_Ioctl GT9762AF_OFG_E266L_Ioctl_Main
#define GT9762AF_OFG_E266L_Release GT9762AF_OFG_E266L_Release_Main
extern void GT9762AF_OFG_E266L_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_OFG_E266L_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_OFG_E266L_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

//zhenglihong@wind-mobi.com 20170208 end

//zhaozhensen@wind-mobi.com 20161308 begin
#ifdef CONFIG_MTK_LENS_GT9762AF_GZ_SUPPORT
#define GT9762AF_GZ_SetI2Cclient GT9762AF_GZ_SetI2Cclient_Main
#define GT9762AF_GZ_Ioctl GT9762AF_GZ_Ioctl_Main
#define GT9762AF_GZ_Release GT9762AF_GZ_Release_Main
extern void GT9762AF_GZ_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_GZ_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_GZ_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//zhaozhensen@wind-mobi.com 20161208 end
//zhaozhensen@wind-mobi.com 20161308 begin
#ifdef CONFIG_MTK_LENS_GT9762AF_S5K3M2_SUPPORT
#define GT9762AF_S5K3M2_SetI2Cclient GT9762AF_S5K3M2_SetI2Cclient_Main
#define GT9762AF_S5K3M2_Ioctl GT9762AF_S5K3M2_Ioctl_Main
#define GT9762AF_S5K3M2_Release GT9762AF_S5K3M2_Release_Main
extern void GT9762AF_S5K3M2_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_S5K3M2_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_S5K3M2_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//zhaozhensen@wind-mobi.com 20161208 end
//dingyisheng@wind-mobi.com 20170811 begin
#ifdef CONFIG_MTK_LENS_GT9762AF_S5K3P3SX_SUPPORT
#define GT9762AF_S5K3P3SX_SetI2Cclient GT9762AF_S5K3P3SX_SetI2Cclient_Main
#define GT9762AF_S5K3P3SX_Ioctl GT9762AF_S5K3P3SX_Ioctl_Main
#define GT9762AF_S5K3P3SX_Release GT9762AF_S5K3P3SX_Release_Main
extern void GT9762AF_S5K3P3SX_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_S5K3P3SX_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_S5K3P3SX_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
#ifdef CONFIG_MTK_LENS_GT9762AF_OV16880_SUPPORT
#define GT9762AF_OV16880_SetI2Cclient GT9762AF_OV16880_SetI2Cclient_Main
#define GT9762AF_OV16880_Ioctl GT9762AF_OV16880_Ioctl_Main
#define GT9762AF_OV16880_Release GT9762AF_OV16880_Release_Main
extern void GT9762AF_OV16880_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_OV16880_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_OV16880_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//dingyisheng@wind-mobi.com 20170811 end
//yeshaobo@wind-mobi.com 20170331 begin
#ifdef CONFIG_MTK_LENS_GT9762AF_OV13855_E266L_SUPPORT
#define GT9762AF_OV13855_E266L_SetI2Cclient GT9762AF_OV13855_E266L_SetI2Cclient_Main
#define GT9762AF_OV13855_E266L_Ioctl GT9762AF_OV13855_E266L_Ioctl_Main
#define GT9762AF_OV13855_E266L_Release GT9762AF_OV13855_E266L_Release_Main
extern void GT9762AF_OV13855_E266L_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AF_OV13855_E266L_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AF_OV13855_E266L_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
