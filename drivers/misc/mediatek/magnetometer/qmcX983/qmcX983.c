//ranyanhao@wind-mobi.com 20161105 begin
...
#ifdef CONFIG_CUSTOM_KERNEL_SOFT_GYROSCOPE 
...
//liukangping@wind-mobi.com 1113 begin
//#define QMC_CHARGE_COMPENSATE  //lihaiyan@wind-mobi.com 20170320
...
#ifdef QMC_CHARGE_COMPENSATE
static int val =2000;
static int COMPENSATE[3] = {74,0,0};
//liukangping@wind-mobi.com 1113 end
#endif
...
//liukangping@wind-mobi.com 1113 begin
	...
	if(upmu_is_chr_det()== KAL_TRUE)
	{
			...
			MSE_LOG("QSTCharge, X_Charge = %d  Y_Charge = %d  Z_Charge = %d\n",hw_d[0],hw_d[1],hw_d[2]);
	}
#endif
//liukangping@wind-mobi.com 1113 end
...
/*----------------------------------------------------------------------------*/
#ifdef QMCX983_M_NEW_ARCH   //modified by lifengxiang@wind-mobi.com 20160628
...
//ranyanhao@wind-mobi.com 20161105 end
