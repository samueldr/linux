...
#define CON4_VREG_SHIFT    3  //yangzhigang@wind-mobi.com 20170612 modify
...
#define CON5_CHG_TIMER_MASK           0x01 //yangzhigang@wind-mobi.com modify 20170621
#define CON5_CHG_TIMER_SHIFT          2 //yangzhigang@wind-mobi.com modify 20170621

#define CON5_TREG_MASK     0x01
#define CON5_TREG_SHIFT    1

#define CON5_JEITA_MASK     0x01      //liulinsheng@wind-mobi.com 20171001
#define CON5_JEITA_SHIFT    0         //liulinsheng@wind-mobi.com 20171001
...
#define	CON6_BOOSTV_MASK	0x03 //yangzhigang@wind-mobi.com 20170621 modify
...
#define	CON7_BATFET_RST_EN_SHIFT	2 //yangzhigang@wind-mobi.com 20170621 modify

#define	CON7_VDPM_BAT_TRACK_MASK	0x03
#define	CON7_VDPM_BAT_TRACK_SHIFT	0

#define	CON7_JTETA_MASK	    0x01   //liulinsheng@wind-mobi.com  20171001
#define	CON7_JIETA_SHIFT	4  //liulinsheng@wind-mobi.com  20171001
...
extern void bq2560x_set_force_20pct(unsigned int val);
//CON3----------------------------------------------------
...
extern void bq2560x_set_term_stat(unsigned int val);
...
extern void bq2560x_set_low_temp_jieta(unsigned int val);   //liulinsheng@wind-mobi.com 20171001
//CON6----------------------------------------------------
...
extern void bq2560x_set_high_temp_jieta(unsigned int val);    //liulinsheng@wind-mobi.com 20171001
//CON8----------------------------------------------------
extern unsigned int bq2560x_get_system_status(void);
extern unsigned int bq2560x_get_vbus_stat(void);
extern unsigned int bq2560x_get_chrg_stat(void);
extern unsigned int bq2560x_get_vsys_stat(void);
//---------------------------------------------------------
