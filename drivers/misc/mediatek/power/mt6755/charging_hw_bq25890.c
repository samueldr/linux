...
static int charging_set_current(void *data)
{
	...
	printk(  "wind: coming current:%d\n", current_value);

	array_size = GETARRAYNUM(CS_VTH);
	set_chr_current = bmt_find_closest_level(CS_VTH, array_size, current_value);
	register_value = charging_parameter_to_value(CS_VTH, array_size, set_chr_current);
	printk(  "wind:real charging_set_ICHG:%d\n", set_chr_current);
...
static int charging_set_suspend_charge(void *data)
{
	int status = STATUS_OK;
	bq25890_config_interface(bq25890_CON7, 0x0, 0x3, 4);	/* disable  watch dog */
	bq25890_config_interface(bq25890_CON0, 0x0, 0x3F, 0);	/* Iinlim=100mA  */
	bq25890_config_interface(bq25890_CON0, 0x1, 0x1, 7);	/* close charge  */
	printk("wind-logcharging_set_suspend_charge");
	return status;
}

static int charging_set_recover_charge(void *data)
{
	int status = STATUS_OK;
	bq25890_config_interface(bq25890_CON7, 0x3, 0x3, 4);	/*  enable watch dog */
	bq25890_config_interface(bq25890_CON0, 0x0, 0x1, 7);	/* recover charge  */
	printk("wind-logcharging_set_recover_charge");
	return status;
}
...
static int charging_sw_init(void *data)
{
	...
	/*CV mode */
	bq25890_config_interface(bq25890_CON6, 0x22, 0x3F, 2);	/*modified by lvwenkang@wind-mobi.com 20161024 VREG=CV 4.384V (default 4.208V) */
	...
	bq25890_config_interface(bq25890_CON2, 0x1, 0x1, 6);	/* modified by liulinsheng@wind-mobi.com 20161024  */

	bq25890_config_interface(bq25890_CON7, 0x3, 0x3, 4);	/* enable  watch dog 160 secs 0x1 */
	...
	bq25890_config_interface(bq25890_CON8, 0x0, 0x7, 5);	/* enable ir_comp_resistance modified by liulinsheng*/
	bq25890_config_interface(bq25890_CON8, 0x0, 0x7, 2);	/* enable ir_comp_vdamp modified by liulinsheng*/
#endif
	bq25890_config_interface(bq25890_CON8, 0x3, 0x3, 0);	/* thermal 120 default */

	bq25890_config_interface(bq25890_CON9, 0x1, 0x1, 4);	/* JEITA_VSET: VREG-200mV   modified by liulinsheng  now is VREG */
	bq25890_config_interface(bq25890_CON7, 0x0, 0x1, 0);	/* JEITA_ISet : 20% x ICHG   modified by liulinsheng now is 50% x ICHG */
	...
	bq25890_config_interface(bq25890_CON6, 0x0, 0x1, 1);	/* modified by lvwenkang@wind-mobi.com 20161024 precharge2cc voltage,BATLOWV, 2.8V */
	/*CV mode */
	bq25890_config_interface(bq25890_CON6, 0x0, 0x1, 0);	/*modified by lvwenkang@wind-mobi.com 20161024  recharge voltage@VRECHG=CV-200MV */
	bq25890_config_interface(bq25890_CON7, 0x1, 0x1, 7);	/* disable ICHG termination detect */
	bq25890_config_interface(bq25890_CON5, 0x1, 0x7, 0);	/*modified by lvwenkang@wind-mobi.com 20161024  termianation current 256 mA */
...
static int (*const charging_func[CHARGING_CMD_NUMBER]) (void *data) = {
	...
	charging_set_ircmp_volt_clamp,charging_set_suspend_charge,charging_set_recover_charge,           //liulinsheng 20171002
};
...
*       None
*/
//liulinsheng@wind-mobi.com 20170925 begin
#ifdef CONFIG_WIND_DEF_PRO_E262L
int bq25890_chr_control_interface(CHARGING_CTRL_CMD cmd, void *data)
#else
int chr_control_interface(CHARGING_CTRL_CMD cmd, void *data)
#endif
//liulinsheng@wind-mobi.com 20170925 end
