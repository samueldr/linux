...
#define PA12200001_IOCTL_MAGIC       			 0X63
#define LSM6DS3_IOCTL_MAGIC				      	0X64

#define PROXIMITY_CALIBRATE    				_IOR(PA12200001_IOCTL_MAGIC,0x06,char*)
#define ACC_CALIBRATE						_IOR(LSM6DS3_IOCTL_MAGIC,0x06,short)
#define GYRO_CALIBRATE					_IOR(LSM6DS3_IOCTL_MAGIC,0x07,short)

#define PROXIMITY_SET_CALIBRATE			_IOW(PA12200001_IOCTL_MAGIC,0x07,char*)
#define ACC_SET_CALIBRATE					_IOW(LSM6DS3_IOCTL_MAGIC,0x08,short)
#define GYRO_SET_CALIBRATE					_IOW(LSM6DS3_IOCTL_MAGIC,0x09,short)
...
/*liukangping@wind-mobi.com 20161108 start*/
