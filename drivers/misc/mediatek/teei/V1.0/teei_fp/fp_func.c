...
struct fp_dev {
	struct cdev cdev;
	unsigned char mem[MICROTRUST_FP_SIZE]; //zhangkaiyuan@wind-mobi.com 20170930
...
{
	int ret = -1;
	//IMSG_ERROR("[TEE] lichen1--->teei_config_flag = %ld\n",teei_config_flag); //zhangkaiyuan@wind-mobi.com 20170930
...
//zhangkaiyuan@wind-mobi.com 20170930 begin
...
//zhangkaiyuan@wind-mobi.com 20170930 end
#ifdef FP_DEBUG
