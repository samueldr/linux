...
//lihaiyan@wind-mobi.com 2010502 begin
...
{
//zhangkaiyuan@wind-mobi.com 201601209 begin
#if defined CONFIG_WIND_E260L_FOR_PASS_CTCERT
    //printk("wind-disp_pwm_level_remap before level_1024 = %d\n",level_1024);
    level_1024 = (level_1024 * 40) / 100;
    if(level_1024 <= 25 && level_1024 > 0) 
      {
		level_1024 = 10;
      }
     //printk("wind-disp_pwm_level_remap after level_1024 = %d\n",level_1024);
#else
//zhangkaiyuan@wind-mobi.com 20161209 end
//lihaiyan@wind-mobi.com 2010502 begin
#if (defined CONFIG_WIND_DEF_PRO_E266L)||(defined CONFIG_WIND_DEF_PRO_E267L)
	if( 0 == strcmp( (char *)(wind_device_info.lcm_module_info.ic_name) , "ili9881c_hd720_dsi_vdo_yassy" ) )
	{
        if(level_1024 <= 25 && level_1024 > 0) 
        {
		    return level_1024;
        }else{
			level_1024 = (level_1024 * 229) / 255;
		}
