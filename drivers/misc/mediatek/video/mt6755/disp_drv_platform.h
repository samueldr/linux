...
// wangjun@wind-mobi.com 20170828 begin 
#define DISP_HW_HRT_PERF_FOR_LCM_FHD	    4
#define DISP_HW_HRT_PERF_FOR_LCM_FHD_MAX	6
#define DISP_HW_HRT_PERF_FOR_LCM_FHDP	    3
#define DISP_HW_HRT_PERF_FOR_LCM_FHDP_MAX	4

#define DISP_HW_HRT_PERF_FOR_LCM_HD    6
#define DISP_HW_HRT_PERF_LCM_HDP_THRESHOLD   (1440 * 800)
#define DISP_HW_HRT_PERF_LCM_FHD_THRESHOLD   (1920 * 1080)
// wangjun@wind-mobi.com 20170828 begin 
