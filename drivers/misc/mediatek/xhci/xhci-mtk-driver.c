...
void mtk_xhci_mode_switch(struct work_struct *work)
{
	...
	if (mtk_idpin_cur_stat == IDPIN_OUT) {
		...
		//zhangkaiyuan -s
		printk("wind-zky4[MUSB]addr: 0x20, value: 0x%x\n",U3PhyReadReg32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1));
	    U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, 0x4);
	    U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, 0x4);
	    printk("wind-zky2[MUSB]addr: 0x20, value: 0x%x\n",U3PhyReadReg32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1));
        //zhangkaiyuan -e
...
#endif
	        //zhangkaiyuan -s
	        U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, 0x7);
	        U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, 0x7);
	        printk("wind-zky3[MUSB]addr: 0x20, value: 0x%x\n",U3PhyReadReg32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1));
            //zhangkaiyuan -e
