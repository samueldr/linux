...
#define FTS_MODULE2_ID				0x84
#define FTS_MODULE3_ID				0x60
#define FTS_MODULE4_ID				0xE8
...
/*
 * if FTS_GET_MODULE_NUM >= 4, fw corrsponding with FTS_VENDOR_ID3
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW4_FILE                     "include/firmware/fw_sample.i"
