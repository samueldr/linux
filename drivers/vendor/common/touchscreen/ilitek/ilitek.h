...
struct ilitek_tddi_dev {
	...
	struct workqueue_struct *ilitek_ts_workqueue;
...
extern void ilitek_tddi_release_resource(void);
...
extern void ilitek_plat_irq_wake_enable(void);
extern void ilitek_plat_irq_wake_disable(void);
...
extern void ilitek_ex_mode_recovery(void);
extern int ilitek_tptest_result;
