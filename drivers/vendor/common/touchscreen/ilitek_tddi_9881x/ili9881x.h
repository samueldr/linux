...
struct ilitek_ts_data {
	...
	struct workqueue_struct *ili9881x_ts_workqueue;
...
struct ilitek_ic_func_ctrl {
	...
	u8 cmd[6];
	int len;
	u8 enble; //0:disable, 1: enable, 2: N/A
};
...
extern u32 ili_fw_read_hw_crc(u32 start, u32 end);
...
extern void ili_tddi_release_resource(void);
