...
unsigned char aw87359_audio_dspk_l(void)
{
	return aw87359_audio_dspk();
}
EXPORT_SYMBOL(aw87359_audio_dspk_l);
...
unsigned char aw87359_audio_off_l(void)
{
	return aw87359_audio_off();
}
EXPORT_SYMBOL(aw87359_audio_off_l);
...
static const struct of_device_id extpa_of_match[] = {
	...
	{.compatible = "awinic,aw87359_pa_l"},
	{},
};
