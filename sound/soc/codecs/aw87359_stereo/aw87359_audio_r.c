...
* aw87359 marco
******************************************************************/
#define AW87359_I2C_NAME        "aw87359_pa_r"
...
static struct aw87359 *aw87359;
static struct aw87359_container *aw87359_dspk_cnt;
static struct aw87359_container *aw87359_drcv_cnt;
static struct aw87359_container *aw87359_abspk_cnt;
static struct aw87359_container *aw87359_abrcv_cnt;

static char *aw87359_dspk_name = "aw87359_dspk_r.bin";
static char *aw87359_drcv_name = "aw87359_drcv_r.bin";
static char *aw87359_abspk_name = "aw87359_abspk_r.bin";
static char *aw87359_abrcv_name = "aw87359_abrcv_r.bin";

static unsigned int dspk_load_cont;
static unsigned int drcv_load_cont;
static unsigned int abspk_load_cont;
static unsigned int abrcv_load_cont;

static const unsigned char aw87359_reg_access[AW87359_REG_MAX] = {
...
************************************************************************/
static unsigned int aw87359_hw_on(struct aw87359 *aw87359)
{
	pr_info("%s enter\n", __func__);
...
static unsigned int aw87359_hw_off(struct aw87359 *aw87359)
{
	pr_info("%s enter\n", __func__);
...
******************************************************************************/
static unsigned char aw87359_audio_dspk(void)
{
	unsigned int i;
	unsigned int length;
...
unsigned char aw87359_audio_dspk_r(void)
{
	return aw87359_audio_dspk();
}
EXPORT_SYMBOL(aw87359_audio_dspk_r);

static unsigned char aw87359_audio_drcv(void)
{
	unsigned int i;
	unsigned int length;
...
static unsigned char aw87359_audio_abspk(void)
{
	unsigned int i;
	unsigned int length;
...
static unsigned char aw87359_audio_abrcv(void)
{
	unsigned int i;
	unsigned int length;
...
static unsigned char aw87359_audio_off(void)
{
	if (aw87359 == NULL)
		return 2;
...
unsigned char aw87359_audio_off_r(void)
{
	return aw87359_audio_off();
}
EXPORT_SYMBOL(aw87359_audio_off_r);
...
* check chip id
*****************************************************/
static int aw87359_read_chipid(struct aw87359 *aw87359)
{
	unsigned int cnt = 0;
	int ret = -1;
	unsigned char reg_val = 0;
...
static const struct of_device_id extpa_of_match[] = {
	...
	{.compatible = "awinic,aw87359_pa_r"},
	{},
};
