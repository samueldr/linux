 ...
 */
#ifndef __TFA1_TFA_FIELD_NAMES_H__
#define __TFA1_TFA_FIELD_NAMES_H__
...
#define TFA1_BITNAMETABLE static tfaBfName_t Tfa1BitNames[] = {\
	...
	{ 0x4830, "iddqtestbst"},    /* for iddq testing in powerstage of boost converter , */\
	/* Switch protection on to prevent simultaneously switching power stages bst and amp, */\
	...
	/* use_direct_pll_ctrl, to overrule several functions direct for testing, */\
	...
	/* ctrl_ocptest, deactivates the over current protection in the power */\
	/* stages of the amplifier. The ocp flag signals stay active.*/\
	{ 0x57c0, "ocptest"}, \
	...
	/* start copying single word from i2cregs_mtp to mtp [Key 1 protected], */\
...
/* General 0x09 settings for all Max1 devices */
/*
 * (0x09)-sys_ctrl
 */
...
#endif /*__TFA1_TFA_FIELD_NAMES_H__*/
