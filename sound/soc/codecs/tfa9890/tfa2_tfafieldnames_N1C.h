 ...
 */
#ifndef __TFA2_TFA_FIELD_NAMES_N1C_H__
#define __TFA2_TFA_FIELD_NAMES_N1C_H__
...
#define TFA2_BITNAMETABLE static tfaBfName_t Tfa2BitNames[] = {\
	...
	/* Control of the number of power stage sections, total of 4 sections.*/\
	/* Each section is 1/4 of the total power stages., */\
	{ 0x5581, "dpsa_drive"}, \
	/* Switch on the class-D power sections, each part of the analog */\
	/* sections can be switched on/off individually - Left channel, */\
	{ 0x560a, "enbl_amp_left"}, \
	{ 0x56b0, "enbl_engage_left"},    /* Enables/engage power stage and control loop - left channel, */\
	/* Switch on the class-D power sections, each part of the analog */\
	/* sections can be switched on/off individually - Right channel, */\
	...
	/* Connect current sense negative to gnda at transitions of */\
	/* booster or classd amplifiers. Otherwise floating (0), */\
	{ 0x8660, "enbl_cs_nofloating_n_left"}, \
	/* Connect current sense positive to gnda at transitions of */\
	/* booster or classd amplifiers. Otherwise floating (0), */\
	...
	/* Analog BIST, switch choose which transistor will be used */\
	/* as current source (also cross coupled sources possible), */\
	{ 0xc500, "test_cvi"}, \
	...
	/* DigimuxA input selection control routed to GPIO1 (see Digimux list for details), */\
	{ 0xc707, "digimuxa_sel"}, \
	/* DigimuxB input selection control routed to GPIO2 (see Digimux list for details), */\
	{ 0xc787, "digimuxb_sel"}, \
	/* DigimuxC input selection control routed to GPIO3 (see Digimux list for details), */\
	{ 0xc807, "digimuxc_sel"}, \
	/* DigimuxD input selection control routed to GPIO4 (see Digimux list for details), */\
	{ 0xc887, "digimuxd_sel"}, \
	...
	{ 0xc921, "dio2_ehs"}, \
	/* Speed/load setting for GAINIO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc941, "gainio_ehs"}, \
	...
	{ 0xc981, "int_ehs"}, \
	/* Speed/load setting for TDO IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc9a1, "tdo_ehs"}, \
	...
	/* Offset for amplifier, HW gain module - right channel (2's complement), */\
	...
	/* Current sense gain - right channel (signed two's complement format), */\
...
#endif				/* __TFA2_TFA_FIELD_NAMES_N1C_H__ */
