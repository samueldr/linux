...
typedef enum nxpTfa9872BfEnumList {
	...
	/*!< Second channel gain in case of stereo using a single coil. */
	/* (Total gain depending on INPLEV). */
	/* (In case of mono OR stereo using 2 separate DCDC channel 1 should be disabled using TDMDCE) */
...
#define TFA9872_NAMETABLE static tfaBfName_t Tfa9872DatasheetNames[] = {\
	...
	{ 0x6f02, "DELCURCOMP"},    /* delay to align compensation signal with current sense signal, */\
...
#define TFA9872_BITNAMETABLE static tfaBfName_t Tfa9872BitNames[] = {\
	...
	{ 0x6f02, "cursense_comp_delay"},    /* delay to align compensation signal with current sense signal, */\
	...
	/* Speed/load setting for PDMDAT  IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xd701, "pdmdat_ehs"}, \
