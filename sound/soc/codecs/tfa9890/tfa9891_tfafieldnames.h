...
#define TFA9891_NAMETABLE static tfaBfName_t Tfa9891DatasheetNames[] = {\
	...
	/* Channel Selection data 2 input */\
	/*(coolflux input, the DCDC converter gets the other signal), */\
	{ 0x450, "CHS3"}, \
	...
	{ 0xf00, "VDDD"},    /* mask flag_por for interrupt generation             , */\
	{ 0xf10, "OTDD"},    /* mask flag_otpok for interrupt generation           , */\
	{ 0xf20, "OVDD"},    /* mask flag_ovpok for interrupt generation           , */\
	{ 0xf30, "UVDD"},    /* mask flag_uvpok for interrupt generation           , */\
	{ 0xf40, "OCDD"},    /* mask flag_ocp_alarm for interrupt generation       , */\
	{ 0xf50, "CLKD"},    /* mask flag_clocks_stable for interrupt generation   , */\
	{ 0xf60, "DCCD"},    /* mask flag_pwrokbst for interrupt generation        , */\
	{ 0xf70, "SPKD"},    /* mask flag_cf_speakererror for interrupt generation , */\
	{ 0xf80, "WDD"},    /* mask flag_watchdog_reset for interrupt generation  , */\
	{ 0xfe0, "INT"},    /* enabling interrupt                                , */\
	{ 0xff0, "INTP"},    /* Setting polarity interrupt                         , */\
...
#define TFA9891_BITNAMETABLE static tfaBfName_t Tfa9891BitNames[] = {\
	...
	{ 0xf00, "flag_por_mask"},    /* mask flag_por for interrupt generation             , */\
	{ 0xf10, "flag_otpok_mask"},    /* mask flag_otpok for interrupt generation           , */\
	{ 0xf20, "flag_ovpok_mask"},    /* mask flag_ovpok for interrupt generation           , */\
	{ 0xf30, "flag_uvpok_mask"},    /* mask flag_uvpok for interrupt generation           , */\
	{ 0xf40, "flag_ocp_alarm_mask"},    /* mask flag_ocp_alarm for interrupt generation       , */\
	{ 0xf50, "flag_clocks_stable_mask"},    /* mask flag_clocks_stable for interrupt generation   , */\
	{ 0xf60, "flag_pwrokbst_mask"},    /* mask flag_pwrokbst for interrupt generation        , */\
	{ 0xf70, "flag_cf_speakererror_mask"},    /* mask flag_cf_speakererror for interrupt generation , */\
	{ 0xf80, "flag_watchdog_reset_mask"},    /* mask flag_watchdog_reset for interrupt generation  , */\
	{ 0xf90, "flag_lost_clk_mask"},    /* mask flag_lost_clk for interrupt generation        , */\
	{ 0xfe0, "enable_interrupt"},    /* enabling interrupt                                , */\
	{ 0xff0, "invert_int_polarity"},    /* Setting polarity interrupt                         , */\
	...
	/* 0 = active input common mode voltage source at the attenuator/PGA level, */\
	...
	/* flag_ocpokap, indication no over current in amplifier "a" pmos output stage, */\
	{ 0x30b0, "flag_ocpokap"}, \
	/* flag_ocpokan, indication no over current in amplifier "a" nmos output stage, */\
	{ 0x30c0, "flag_ocpokan"}, \
	/* flag_ocpokbp, indication no over current in amplifier "b" pmos output stage, */\
	{ 0x30d0, "flag_ocpokbp"}, \
	/* flag_ocpokbn, indication no over current in amplifier"b" nmos output stage, */\
	{ 0x30e0, "flag_ocpokbn"}, \
	...
	{ 0x4830, "ctrl_iddqtestbst"},    /* for iddq testing in powerstage of boost converter , */\
	...
	/* ABIST mode to add both amplifier halves as stereo or one amplifier half as mono, */\
	...
	/* Digimux TEST2 out. output flag_clipa_low depending on cntr_bypassclip setting, */\
	{ 0x5343, "ctrl_digimux_out_test2"}, \
	/* Digimux DATA1 out (output flag_clipb_high depending on cntr_bypassclip setting), */\
	{ 0x5383, "ctrl_digimux_out_data1"}, \
	/* Digimux DATA3 out  (output flag_clipx_x depending on cntr_bypassclip setting), */\
	...
	/* use_direct_clk_ctrl, to overrule several functions direct for testing, */\
	{ 0x56c0, "use_direct_clk_ctrl"}, \
	{ 0x56d0, "use_direct_pll_ctrl"},    /* use_direct_pll_ctrl, to overrule several functions direct for test, */\
	/* use_direct_sourseamp_ctrls, to overrule several functions direct for testing, */\
	{ 0x56e0, "use_direct_ctrls_2"}, \
	{ 0x5707, "ctrl_anamux_out_test1"},    /* Anamux control                                    , */\
	{ 0x5782, "ctrl_zero"},    /* Bandwidth control feedbackloop                     , */\
	{ 0x57b0, "enbl_ldo_stress"},    /* LDO stress function frinch capacitors             , */\
	/* ctrl_ocptest, deactivates the over current protection */\
	/* in the power stages of the amplifier. The ocp flag signals stay active., */\
	{ 0x57c0, "ctrl_ocptest"}, \
	...
	/* mtp_direct_wr(key1 protected) direct value for mtp pin wr. To be enabled via iic2mtp_mtp_direct_enable, */\
	{ 0x6350, "mtp_direct_wr"}, \
	/* mtp_direct_rd(key1 protected) direct value for mtp pin rd. To be enabled via iic2mtp_mtp_direct_enable, */\
	{ 0x6360, "mtp_direct_rd"}, \
	/* mtp_direct_rst(key1 protected) direct value for mtp pin rst. To be enabled via iic2mtp_mtp_direct_enable, */\
	{ 0x6370, "mtp_direct_rst"}, \
	/* mtp_direct_ers(key1 protected) direct value for mtp pin ers. To be enabled via iic2mtp_mtp_direct_enable, */\
	{ 0x6380, "mtp_direct_ers"}, \
	/* mtp_direct_prg(key1 protected) direct value for mtp pin prg. To be enabled via iic2mtp_mtp_direct_enable, */\
	{ 0x6390, "mtp_direct_prg"}, \
	/* mtp_direct_epp(key1 protected) direct value for mtp pin epp. To be enabled via iic2mtp_mtp_direct_enable, */\
