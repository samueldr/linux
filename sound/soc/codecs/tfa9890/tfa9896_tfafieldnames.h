...
#define TFA9896_NAMETABLE static tfaBfName_t Tfa9896DatasheetNames[] = {\
	...
	{ 0x7387, "ACK"},    /* CF acknowledgment of the requests channels       , */\
...
#define TFA9896_BITNAMETABLE static tfaBfName_t Tfa9896BitNames[] = {\
	...
	/* DCDC threshold required on a delta Vbat (in PFM mode) switching to PWM mode, */\
	...
	/* Status flag_ocpokbst, indication no over current in boost converter PMOS switch, */\
	{ 0x3040, "flag_ocpokbst"}, \
	/* Status flag_peakcur, indication current is max in dcdc converter, */\
	{ 0x3050, "flag_peakcur"}, \
	/* Status flag_ocpokap, indication no over current in amplifier A PMOS output stage, */\
	{ 0x3060, "flag_ocpokap"}, \
	/* Status flag_ocpokan, indication no over current in amplifier A NMOS output stage, */\
	{ 0x3070, "flag_ocpokan"}, \
	/* Status flag_ocpokbp, indication no over current in amplifier B PMOS output stage, */\
	{ 0x3080, "flag_ocpokbp"}, \
	/* Status flag_ocpokbn, indication no over current in amplifier B NMOS output stage, */\
	{ 0x3090, "flag_ocpokbn"}, \
	...
	/* Use direct controls to overrule several functions for testing - I2C direct control mode, */\
	...
	{ 0x7387, "cf_ack"},    /* CF acknowledgment of the requests channels       , */\
