 ...
 *  This file was generated automatically on 09/15/16 at 15:53:30.
 *  Source file: TFA9912_N1A_I2C_regmap_V1.32.xlsx
 */

#ifndef _TFA9912_TFAFIELDNAMES_H
#define _TFA9912_TFAFIELDNAMES_H

#define TFA9912_I2CVERSION    1.32
...
typedef enum nxpTfa9912BfEnumList {
	...
	TFA9912_BF_PDM2IISEN = 0x0610,	/*!< PDM2IIS Brifge enable                              */
	/*!< Tap decimator reset bypass - Bypass the decimator reset from tapdec */
	...
	TFA9912_BF_COMPINITIME = 0x06c1,	/*!< Comparator initialisation time to be used in TapMachine */
	TFA9912_BF_ANAPINITIME = 0x06e1,	/*!< Analog initialisation time to be used in TapMachine */
	...
	TFA9912_BF_TDMSTAT = 0x11a2,	/*!< indicates current is max in DC-to-DC converter     */
	...
	TFA9912_BF_TDMCFE = 0x2360,	/*!< DSP                                                */
	TFA9912_BF_TDMCF2E = 0x2370,	/*!< DSP 2                                              */
	TFA9912_BF_TDMCF3E = 0x2380,	/*!< DSP 3                                              */
	...
	TFA9912_BF_TDMCFIO = 0x24c1,	/*!< IO DSP                                             */
	TFA9912_BF_TDMCFIO2 = 0x24e1,	/*!< IO DSP 2                                           */
	TFA9912_BF_TDMCFIO3 = 0x2501,	/*!< IO DSP 3                                           */
	...
	TFA9912_BF_TDMCFS = 0x2783,	/*!< Slot Position DSPout                               */
	TFA9912_BF_TDMCF2S = 0x27c3,	/*!< Slot Position DSPout2                              */
	TFA9912_BF_TDMCF3S = 0x2803,	/*!< Slot Position of DSPout3                           */
	...
	TFA9912_BF_ICLLA = 0x4660,	/*!< Clear low amplidetude detection                    */
	...
	TFA9912_BF_IELA = 0x4a60,	/*!< Enable low amplidetude detection                   */
	TFA9912_BF_IEVDDP = 0x4a70,	/*!< Enable VDDP greater tehn VBAT                      */
	...
	TFA9912_BF_IETAPTRG = 0x4ac0,	/*!< Enable vomparator interrupt                        */
	...
	TFA9912_BF_IPOLA = 0x4e60,	/*!< Polarity low amplidetude detection                 */
	...
	/*!< Adaptive boost trip levels 1, effective only when boost_intelligent is set to 1 */
	TFA9912_BF_TIPLVL1 = 0x7504,
	/*!< Adaptive boost trip level 2, effective only when boost_intelligent is set to 1 */
	TFA9912_BF_TIPLVL2 = 0x7554,
	/*!< Adaptive boost trip levels, effective only when boost_intelligent is set to 1 */
	TFA9912_BF_TIPLVLT = 0x75a4,
	TFA9912_BF_DCVOF = 0x7635,	/*!< First boost voltage level(I2Csetting+10)*0.16049 +1.25 */
...
#define TFA9912_NAMETABLE static tfaBfName_t Tfa9912DatasheetNames[] = {\
	...
	{ 0x610, "PDM2IISEN"},    /* PDM2IIS Brifge enable                             , */\
	...
	{ 0x6c1, "COMPINITIME"},    /* Comparator initialisation time to be used in TapMachine, */\
	{ 0x6e1, "ANAPINITIME"},    /* Analog initialisation time to be used in TapMachine, */\
	...
	{ 0x11a2, "TDMSTAT"},    /* indicates current is max in DC-to-DC converter    , */\
	...
	{ 0x2360, "TDMCFE"},    /* DSP                                               , */\
	{ 0x2370, "TDMCF2E"},    /* DSP 2                                             , */\
	{ 0x2380, "TDMCF3E"},    /* DSP 3                                             , */\
	...
	{ 0x24c1, "TDMCFIO"},    /* IO DSP                                            , */\
	{ 0x24e1, "TDMCFIO2"},    /* IO DSP 2                                          , */\
	{ 0x2501, "TDMCFIO3"},    /* IO DSP 3                                          , */\
	...
	{ 0x2783, "TDMCFS"},    /* Slot Position DSPout                              , */\
	{ 0x27c3, "TDMCF2S"},    /* Slot Position DSPout2                             , */\
	{ 0x2803, "TDMCF3S"},    /* Slot Position of DSPout3                          , */\
	...
	{ 0x4660, "ICLLA"},    /* Clear low amplidetude detection                   , */\
	...
	{ 0x4a60, "IELA"},    /* Enable low amplidetude detection                  , */\
	{ 0x4a70, "IEVDDP"},    /* Enable VDDP greater tehn VBAT                     , */\
	...
	{ 0x4ac0, "IETAPTRG"},    /* Enable vomparator interrupt                       , */\
	...
	{ 0x4e60, "IPOLA"},    /* Polarity low amplidetude detection                , */\
	...
	{ 0x7635, "DCVOF"},    /* First boost voltage level(I2Csetting+10)*0.16049 +1.25, */\
...
#define TFA9912_BITNAMETABLE static tfaBfName_t Tfa9912BitNames[] = {\
	...
	{ 0x6c1, "comp_init_time"},    /* Comparator initialisation time to be used in TapMachine, */\
	{ 0x6e1, "ana_init_time"},    /* Analog initialisation time to be used in TapMachine, */\
	...
	{ 0x11a2, "flag_tdm_status"},    /* indicates current is max in DC-to-DC converter    , */\
	...
	{ 0x2360, "tdm_source3_enable"},    /* DSP                                               , */\
	{ 0x2370, "tdm_source4_enable"},    /* DSP 2                                             , */\
	{ 0x2380, "tdm_source5_enable"},    /* DSP 3                                             , */\
	...
	{ 0x24c1, "tdm_source3_io"},    /* IO DSP                                            , */\
	{ 0x24e1, "tdm_source4_io"},    /* IO DSP 2                                          , */\
	{ 0x2501, "tdm_source5_io"},    /* IO DSP 3                                          , */\
	...
	{ 0x2783, "tdm_source3_slot"},    /* Slot Position DSPout                              , */\
	{ 0x27c3, "tdm_source4_slot"},    /* Slot Position DSPout2                             , */\
	{ 0x2803, "tdm_source5_slot"},    /* Slot Position of DSPout3                          , */\
	...
	{ 0x4660, "int_in_flag_low_amplitude"},    /* Clear low amplidetude detection                   , */\
	...
	{ 0x4a60, "int_enable_flag_low_amplitude"},    /* Enable low amplidetude detection                  , */\
	...
	{ 0x4ac0, "int_enable_flag_tap_comp_trig"},    /* Enable vomparator interrupt                       , */\
	...
	{ 0x4e60, "int_polarity_flag_low_amplitude"},    /* Polarity low amplidetude detection                , */\
	...
	/* Switch on the class-D power sections, each part of */\
	/* the analog sections can be switched on/off individually , */\
	{ 0x570a, "enbl_amp"}, \
	...
	/* Threshold before booster is reacting on a delta */\
	/* Vbat (in PFM mode) by temporarily switching to PWM mode, */\
	...
	{ 0x6990, "sam_spkr_sel"},    /* SAM o/p sel during SAM and audioo                 , */\
	...
	/* To set the amount of pwm pulse that may be skipped before clip-flag is triggered. , */\
	...
	/* Selection of data for adaptive boost algorithm, */\
	/* effective only when boost_intelligent is set to 1, */\
	...
	/* DCDC Boost decay speed after a peak value, effective only when boost_track is set to 1, */\
	{ 0x7602, "track_decay"}, \
	{ 0x7635, "frst_boost_voltage"},    /* First boost voltage level(I2Csetting+10)*0.16049 +1.25, */\
	...
	/* Connect current sense negative to gnda at transitions */\
	/* of booster or classd amplifiers. Otherwise floating (0), */\
	{ 0x8760, "enbl_cs_nofloating_n"}, \
	/* Connect current sense positive to gnda at transitions */\
	/* of booster or classd amplifiers. Otherwise floating (0), */\
	...
	/* Switch on the analog references, each part of */\
	/* the references can be switched on/off individually -  - I2C direct mode, */\
	{ 0xc038, "enbl_ref"}, \
	...
	/* Analog BIST, switch choose which transistor will be */\
	/* used as current source (also cross coupled sources possible), */\
	{ 0xc500, "test_cvi"}, \
	...
	/* DigimuxA input selection control routed to DIO4 (see Digimux list for details), */\
	{ 0xc707, "digimuxa_sel"}, \
	/* DigimuxB input selection control routed to DIO3 (see Digimux list for details), */\
	{ 0xc787, "digimuxb_sel"}, \
	/* DigimuxC input selection control routed to TDO (see Digimux list for details), */\
	{ 0xc807, "digimuxc_sel"}, \
	/* Speed/load setting for DIO1 IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc901, "dio1_ehs"}, \
	/* Speed/load setting for DIO2 IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc921, "dio2_ehs"}, \
	/* Speed/load setting for DIO3 cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc941, "dio3_ehs"}, \
	/* Speed/load setting for DIO4 IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc961, "dio4_ehs"}, \
	/* Speed/load setting for PDMO IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc981, "spdmo_ehs"}, \
	/* Speed/load setting for TDM IO cell, clk or data mode range (see SLIMMF IO cell datasheet), */\
	{ 0xc9a1, "tdo_ehs"}, \
	{ 0xc9c0, "int_ehs"},    /* Slew Rate INT IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	/* Slew RateBCK2/PDMCLK IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	{ 0xc9d0, "pdmclk_ehs"}, \
	...
	{ 0xcc64, "pll_selp_lbw"},    /* PLL SELP - Low B/W PLL control modeor I2C direct PLL control mode only, */\
	{ 0xccb3, "pll_selr_lbw"},    /* PLL SELR - Low B/W PLL control mode or I2C direct PLL control mode only, */\
	{ 0xccf0, "sel_user_pll_bw"},    /* PLLLow BandWidth Mode comtrol                     , */\
	...
	{ 0xd681, "dsp_tap_clk"},    /* Dsp clock ferquency selection in TAP mode;        , */\
	...
	{ 0xed00, "enbl_fro8cal"},    /* Enable FRO  claibration                           , */\
	{ 0xed10, "start_fro8_calibration"},    /* Start FRO8 Calibration                            , */\
	{ 0xed20, "fro8_calibration_done"},    /* FRO8 Calibration done - Read Only                 , */\
	/* Calibration value from Auto Calibration block, to be written into MTP - Read Only, */\
