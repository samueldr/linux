 ...
 */
	enum Tfa98xx_Status_ID {
		...
		/* Request executed correctly and result, if any, is available for download */
		 ...
		 * host has sent too many parameters, memory integrity is not guaranteed */
 ...
 */
	enum Tfa98xx_Error tfa98xx_select_stereo_gain_channel(Tfa98xx_handle_t
							      handle,
							      enum
							      Tfa98xx_StereoGainSel
							      gain_sel);
 ...
 */
	...
	enum Tfa98xx_Error tfa98xx_get_mtp(Tfa98xx_handle_t handle,
					   uint16_t *value);
 ...
 */
	enum Tfa98xx_Error
	 tfa98xx_dsp_get_sw_feature_bits(Tfa98xx_handle_t handle,
					 int features[2]);
	enum Tfa98xx_Error
	 tfa98xx_dsp_get_hw_feature_bits(Tfa98xx_handle_t handle,
					 int *features);
/*
 ...
 * @return error code
 */
	enum Tfa98xx_Error tfa98xx_dsp_reset(Tfa98xx_handle_t handle,
					     int state);
 ...
 */
	enum Tfa98xx_Error tfa98xx_dsp_write_speaker_parameters(Tfa98xx_handle_t
								handle,
								int length,
								const unsigned
								char
 ...
 */
	enum Tfa98xx_Error tfa98xx_dsp_read_speaker_parameters(Tfa98xx_handle_t
							       handle,
							       int length,
							       unsigned char
							       *pSpeakerBytes);
 ...
 */
	enum Tfa98xx_Error tfa98xx_dsp_read_excursion_model(Tfa98xx_handle_t
							    handle, int length,
							    unsigned char
							    *pSpeakerBytes);
 ...
 */
	enum Tfa98xx_Error tfa_dsp_cmd_id_MBDrc_dynamics(Tfa98xx_handle_t
							 handle,
							 unsigned char
							 module_id,
							 unsigned char param_id,
 ...
 */
	enum Tfa98xx_Error dsp_msg(Tfa98xx_handle_t handle, int length,
				   const char *buf);
	enum Tfa98xx_Error dsp_msg_read(Tfa98xx_handle_t handle, int length,
					unsigned char *bytes);
	enum Tfa98xx_Error reg_write(Tfa98xx_handle_t handle,
				     unsigned char subaddress,
				     unsigned short value);
	enum Tfa98xx_Error tfa_reg_read(Tfa98xx_handle_t handle,
				    unsigned char subaddress,
				    unsigned short *value);
	enum Tfa98xx_Error mem_write(Tfa98xx_handle_t handle,
				     unsigned short address, int value,
				     int memtype);
	enum Tfa98xx_Error mem_read(Tfa98xx_handle_t handle,
 ...
 * @param cmdid command identifier
*/
	enum Tfa98xx_Error tfa_dsp_msg_write_id(Tfa98xx_handle_t handle,
						int length, const char *buffer,
						uint8_t cmdid[3]);
...
*/
	enum Tfa98xx_Error tfa_dsp_msg_status(Tfa98xx_handle_t handle,
					      int *pRpcStatus);
 ...
 */
	enum Tfa98xx_Error tfaRunColdStartup(Tfa98xx_handle_t handle,
					     int profile);
 ...
 * @param profile the profile that should be loaded
 */
	enum Tfa98xx_Error tfaRunSpeakerBoost(Tfa98xx_handle_t handle,
 ...
 */
	enum Tfa98xx_Error tfaRunSpeakerStartup(Tfa98xx_handle_t handle,
						int force, int profile);
 ...
 */
	void tfa_mock_probe(int dev_idx, unsigned short revid,
			    int slave_address);
