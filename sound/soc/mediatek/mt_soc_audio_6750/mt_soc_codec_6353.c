...
static void Voice_Amp_Change(bool enable)
{
	if (enable) {
		...
		if (GetDLStatus() == false) {
			...
			/* Enable voice driver */
			udelay(50);
			//modify by gaohui@wind-mobi.com 20170215 for Bug#153563 begin
			/*Ana_Set_Reg(MT6353_ZCD_CON3, 0x0000, 0xffff);*/
			Ana_Set_Reg(MT6353_ZCD_CON3,mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_HSOUTL], 0xffff);
			//modify by gaohui@wind-mobi.com 20170215 for Bug#153563 end
...
#else
//ranyanhao@wind-mobi.com 20161011 begin
		AudDrv_GPIO_EXTAMP_Select(false,3);
		AudDrv_GPIO_EXTAMP2_Select(false,3);
//ranyanhao@wind-mobi.com 20161011 end
...
void InitCodecDefault(void)
{
    ...
    //add by gaohui@wind-mobi.com 20170215 for Bug#153563 begin
    mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_HSOUTL] = 8;
    mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_HSOUTR] = 8;
    //add by gaohui@wind-mobi.com 20170215 for Bug#153563 add end
